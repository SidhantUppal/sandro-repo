...
SET @v = N'Permit Expiration utc Date'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PERMIT_EXPIRATION_UTC_TIME'
GO
...
DECLARE @v sql_variant 
SET @v = N'Permit Expiration utc Date'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PERMIT_EXPIRATION_UTC_TIME'
GO
...
/****** Object:  Trigger [dbo].[TR_OPERATIONS]    Script Date: 06/11/2018 16:34:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
