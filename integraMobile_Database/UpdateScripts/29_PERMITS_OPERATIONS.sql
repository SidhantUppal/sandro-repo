...
SET @v = N'Permit Autorenew'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PERMIT_AUTO_RENEW'
GO
DECLARE @v sql_variant 
SET @v = N'Permit Expiration Date'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PERMIT_EXPIRATION_TIME'
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	DF_HIS_OPERATIONS_OPE_PERMIT_AUTO_RENEW DEFAULT 1 FOR OPE_PERMIT_AUTO_RENEW
GO
...
DECLARE @v sql_variant 
SET @v = N'Permit Autorenew'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PERMIT_AUTO_RENEW'
GO
DECLARE @v sql_variant 
SET @v = N'Permit Expiration Date'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PERMIT_EXPIRATION_TIME'
GO
...
/****** Object:  Trigger [dbo].[TR_OPERATIONS]    Script Date: 05/11/2018 11:22:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
