...
/****** Object:  View [dbo].[VW_USERS]    Script Date: 5/26/2020 11:09:06 AM ******/
SET ANSI_NULLS ON
GO
...
FROM            dbo.USERS INNER JOIN
						 ...
						 WHERE 							
							(dbo.USERS.USR_FIRST_OPERATION_INS_ID NOT IN (SELECT INS_ID FROM INSTALLATIONS INNER JOIN COUNTRIES_REDIRECTIONS ON INS_COU_ID = COURE_COU_ID) or USR_FIRST_OPERATION_INS_ID is null)
							AND (dbo.USERS.USR_LAST_OPERATION_INS_ID NOT IN (SELECT INS_ID FROM INSTALLATIONS INNER JOIN COUNTRIES_REDIRECTIONS ON INS_COU_ID = COURE_COU_ID)  or USR_LAST_OPERATION_INS_ID is null)
GO
