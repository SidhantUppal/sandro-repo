/****** Object:  View [dbo].[ALL_CURR_OPERATIONS]    Script Date: 15/11/2018 15:05:20 ******/
SET ANSI_NULLS ON
GO
...
FROM		dbo.OPERATIONS_OFFSTREET LEFT OUTER JOIN
                         ...
                         dbo.GROUPS ON OPEOFF_GRP_ID = GRP_ID,
						 INSTALLATIONS
...
SELECT      15, BAT_DST_USR_ID, NULL, NULL, NULL, BAT_DATE, BAT_UTC_DATE, NULL, NULL, BAT_DST_AMOUNT, BAT_DST_AMOUNT,  NULL, BAT_DST_BALANCE_CUR_ID, 
			...
			NULL OPE_CUSPMR_TYPE, NULL OPE_CUSPMR_PAGATELIA_NEW_BALANCE, NULL OPE_TIME_BALANCE_USED, NULL OPE_TIME_BALANCE_BEFORE, NULL OPE_POSTPAY, BAT_SHOPKEEPER_OP, BAT_SHOPKEEPER_COLLECTED_AMOUNT, BAT_SHOPKEEPER_PROFIT,
			NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
FROM            dbo.BALANCE_TRANSFERS, dbo.CURRENCIES, USERS
...
ALTER VIEW [dbo].[ALL_OPERATIONS] AS
	SELECT        CASE ISNULL(TAR_TYPE, 0) WHEN 1 THEN 19 ELSE OPE_TYPE END AS OPE_TYPE, OPE_USR_ID, OPE_INS_ID, INS_DESCRIPTION, INS_SHORTDESC, OPE_DATE, OPE_UTC_DATE, OPE_INIDATE, OPE_ENDDATE, OPE_REFUND_PREVIOUS_ENDDATE, 
							 ...
							 OPE_BALANCE_CUR_ID, CUR2.CUR_ISO_CODE OPE_BALANCE_CUR_ISO_CODE, cast(CUR2.CUR_MINOR_UNIT AS int) OPE_BALANCE_CUR_MINOR_UNIT, OPE_CHANGE_APPLIED, USER_PLATES.USRP_ID, 
							 USER_PLATES.USRP_PLATE, NULL TIPA_TICKET_NUMBER, NULL TIPA_TICKET_DATA, NULL SECH_SECHT_ID, GRP_ID, TAR_ID, GRP_DESCRIPTION, TAR_DESCRIPTION, OPE_SUSCRIPTION_TYPE, OPE_BALANCE_BEFORE, 
