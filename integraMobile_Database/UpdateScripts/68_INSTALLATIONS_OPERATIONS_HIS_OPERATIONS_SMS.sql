/*    INSTALLATIONS_OPERATIONS_HIS_OPERATIONS_SMS   */

ALTER TABLE dbo.INSTALLATIONS ADD
	INS_SEND_EXPIRE_OP_SMS int NULL,
	INS_SEND_EXPIRE_OP_SMS_MINUTES_BEFORE int NULL,
	INS_WARN_NO_PHONE int NULL
GO



ALTER TABLE dbo.OPERATIONS ADD
	OPE_EXPIRE_SMS_SENT int NULL DEFAULT 0
GO
...
ALTER TABLE dbo.INSTALLATIONS ADD CONSTRAINT
	DF_INSTALLATIONS_INS_SEND_EXPIRE_OP_SMS DEFAULT 0 FOR INS_SEND_EXPIRE_OP_SMS
GO
ALTER TABLE dbo.INSTALLATIONS ADD CONSTRAINT
	DF_INSTALLATIONS_INS_SEND_EXPIRE_OP_SMS_MINUTES_BEFORE DEFAULT 0 FOR INS_SEND_EXPIRE_OP_SMS_MINUTES_BEFORE
GO
ALTER TABLE dbo.INSTALLATIONS ADD CONSTRAINT
	DF_INSTALLATIONS_INS_WARN_NO_PHONE DEFAULT 0 FOR INS_WARN_NO_PHONE
GO

UPDATE INSTALLATIONS SET INS_SEND_EXPIRE_OP_SMS=0, INS_SEND_EXPIRE_OP_SMS_MINUTES_BEFORE=0, INS_WARN_NO_PHONE=0
GO
...
INSERT INTO HIS_OPERATIONS (OPE_ID,OPE_USR_ID,OPE_MOSE_OS,OPE_USRP_ID ,OPE_INS_ID,OPE_TYPE,OPE_GRP_ID,OPE_TAR_ID,OPE_DATE ,
						...
						OPE_ADDITIONAL_PARAMS,OPE_EXPIRE_SMS_SENT)
  SELECT i.OPE_ID,i.OPE_USR_ID,i.OPE_MOSE_OS,i.OPE_USRP_ID ,i.OPE_INS_ID,i.OPE_TYPE,i.OPE_GRP_ID,i.OPE_TAR_ID,i.OPE_DATE ,
	...
	OPERATIONS.OPE_ADDITIONAL_PARAMS, i.OPE_EXPIRE_SMS_SENT
  FROM Inserted i
