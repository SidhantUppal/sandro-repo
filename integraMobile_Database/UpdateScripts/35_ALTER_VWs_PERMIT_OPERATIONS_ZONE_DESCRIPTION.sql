ALTER VIEW VW_ACTIVE_PERMIT_OPERATIONS AS
	SELECT o1.*, c.CUR_ISO_CODE AS OPE_AMOUNT_CUR_ISO_CODE, c.CUR_MINOR_UNIT AS OPE_AMOUNT_CUR_MINOR_UNIT, t.TAR_DESCRIPTION, p1.USRP_PLATE, p1.USRP_ID, g.GRP_DESCRIPTION
	FROM   operations o1, 
		   tariffs t, 
		   user_plates p1,
		   currencies c,
