...
SET @v = N'Operation Bonus'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_BON_MLT'
GO
...
DECLARE @v sql_variant 
SET @v = N'Operation Bonus'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_BON_MLT'
GO
...
/****** Object:  Trigger [dbo].[TR_OPERATIONS]    Script Date: 26/06/2018 17:46:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT INTO HIS_OPERATIONS (OPE_ID,OPE_USR_ID,OPE_MOSE_OS,OPE_USRP_ID ,OPE_INS_ID,OPE_TYPE,OPE_GRP_ID,OPE_TAR_ID,OPE_DATE ,
						...
						OPE_AMOUNT_WITHOUT_BON, OPE_BON_MLT, OPE_AUTH_ID)
  SELECT i.OPE_ID,i.OPE_USR_ID,i.OPE_MOSE_OS,i.OPE_USRP_ID ,i.OPE_INS_ID,i.OPE_TYPE,i.OPE_GRP_ID,i.OPE_TAR_ID,i.OPE_DATE ,
	...
	i.OPE_AMOUNT_WITHOUT_BON, i.OPE_BON_MLT, i.OPE_AUTH_ID
  FROM Inserted i
