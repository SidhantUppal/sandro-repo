...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.USER_PLATES SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
...
SET @v = N'User Plate 2 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE2_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 3 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE3_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 4 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE4_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 5 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE5_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 6 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE6_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 7 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE7_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 8 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE8_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 9 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE9_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 10 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'OPERATIONS', N'COLUMN', N'OPE_PLATE10_USRP_ID'
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES1 FOREIGN KEY
	(
	OPE_PLATE2_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
	USRP_ID
	) ON UPDATE  NO ACTION 
	 ON DELETE  NO ACTION 
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES2 FOREIGN KEY
	(
	OPE_PLATE3_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES3 FOREIGN KEY
	(
	OPE_PLATE4_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES4 FOREIGN KEY
	(
	OPE_PLATE5_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES5 FOREIGN KEY
	(
	OPE_PLATE6_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES6 FOREIGN KEY
	(
	OPE_PLATE7_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES7 FOREIGN KEY
	(
	OPE_PLATE8_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES8 FOREIGN KEY
	(
	OPE_PLATE9_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.OPERATIONS ADD CONSTRAINT
	FK_OPERATIONS_USER_PLATES9 FOREIGN KEY
	(
	OPE_PLATE10_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
DECLARE @v sql_variant 
SET @v = N'User Plate 2 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE2_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 3 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE3_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 4 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE4_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 5 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE5_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 6 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE6_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 7 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE7_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 8 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE8_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 9 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE9_USRP_ID'
GO
DECLARE @v sql_variant 
SET @v = N'User Plate 10 id optional'
EXECUTE sp_addextendedproperty N'MS_Description', @v, N'SCHEMA', N'dbo', N'TABLE', N'HIS_OPERATIONS', N'COLUMN', N'OPE_PLATE10_USRP_ID'
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES1 FOREIGN KEY
	(
	OPE_PLATE2_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES2 FOREIGN KEY
	(
	OPE_PLATE3_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES3 FOREIGN KEY
	(
	OPE_PLATE4_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES4 FOREIGN KEY
	(
	OPE_PLATE5_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES5 FOREIGN KEY
	(
	OPE_PLATE6_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES6 FOREIGN KEY
	(
	OPE_PLATE7_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES7 FOREIGN KEY
	(
	OPE_PLATE8_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES8 FOREIGN KEY
	(
	OPE_PLATE9_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
...
GO
ALTER TABLE dbo.HIS_OPERATIONS ADD CONSTRAINT
	FK_HIS_OPERATIONS_USER_PLATES9 FOREIGN KEY
	(
	OPE_PLATE10_USRP_ID
	) REFERENCES dbo.USER_PLATES
	(
