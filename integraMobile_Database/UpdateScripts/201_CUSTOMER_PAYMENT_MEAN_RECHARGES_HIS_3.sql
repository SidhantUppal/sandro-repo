/****** Object:  View [dbo].[ALL_CURR_OPERATIONS]    Script Date: 7/8/2021 6:29:41 AM ******/
SET ANSI_NULLS ON
GO
...
UNION ALL
SELECT        4 OPE_TYPE, TIPA_USR_ID, TIPA_INS_ID, INS_DESCRIPTION, INS_SHORTDESC, TIPA_DATE, TIPA_UTC_DATE, NULL, NULL, - TIPA_AMOUNT TIPA_AMOUNT, - TIPA_AMOUNT TIPA_REAL_AMOUNT, NULL, TIPA_AMOUNT_CUR_ID, 
...
UNION ALL
SELECT        5 OPE_TYPE, CUSPMR_USR_ID, NULL, NULL, NULL, CUSPMR_DATE, CUSPMR_UTC_DATE, NULL, NULL, CUSPMR_AMOUNT, CUSPMR_AMOUNT, NULL, CUSPMR_CUR_ID, 
...
UNION ALL
SELECT        6 OPE_TYPE, SECH_USR_ID, NULL, NULL, NULL, SECH_DATE, SECH_UTC_DATE, NULL, NULL, - SECH_AMOUNT, -SECH_AMOUNT, NULL, SECH_AMOUNT_CUR_ID, CUR1.CUR_ISO_CODE OPE_AMOUNT_CUR_ISO_CODE, 
...
UNION ALL
SELECT        7 OPE_TYPE, OPEDIS_USR_ID, NULL, NULL, NULL, OPEDIS_DATE, OPEDIS_UTC_DATE, NULL, NULL, OPEDIS_AMOUNT, OPEDIS_AMOUNT, NULL, OPEDIS_AMOUNT_CUR_ID, 
...
UNION ALL
SELECT        EPO_TYPE, USRP_USR_ID, EPO_INS_ID, INS_DESCRIPTION, INS_SHORTDESC, EPO_DATE, EPO_DATE_UTC, EPO_INIDATE, EPO_ENDDATE, - EPO_AMOUNT, -EPO_AMOUNT, EPO_TIME, INS_CUR_ID, CUR_ISO_CODE, 
...
UNION ALL
SELECT		OPEOFF_TYPE, OPEOFF_USR_ID, OPEOFF_INS_ID, INS_DESCRIPTION, INS_SHORTDESC, 
...
UNION ALL
SELECT        14, BAT_SRC_USR_ID, NULL, NULL, NULL, BAT_DATE, BAT_UTC_DATE, NULL, NULL,
...
SELECT      15, BAT_DST_USR_ID, NULL, NULL, NULL, BAT_DATE, BAT_UTC_DATE, NULL, NULL, BAT_DST_AMOUNT, BAT_DST_AMOUNT,  NULL, BAT_DST_BALANCE_CUR_ID, 
...
SELECT      TOLM_TYPE, TOLM_USR_ID, TOLM_INS_ID, INS_DESCRIPTION, INS_SHORTDESC, TOLM_DATE, TOLM_UTC_DATE, NULL, NULL,
			CAST( CASE 
					  WHEN TOLM_TYPE = 2
						 THEN TOLM_AMOUNT 
					  ELSE -TOLM_AMOUNT 
...
/****** Object:  View [dbo].[ALL_CURR_OPERATIONS_EXT]    Script Date: 7/8/2021 6:36:47 AM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[ALL_OPERATIONS]    Script Date: 7/8/2021 6:43:46 AM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[ALL_OPERATIONS_EXT]    Script Date: 7/8/2021 6:46:58 AM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[ALL_OPERATIONS_EXT_DB]    Script Date: 7/8/2021 6:50:02 AM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[ALL_OPERATIONS_EXT_DB_HIS]    Script Date: 7/8/2021 6:52:21 AM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[ALL_OPERATIONS_EXT_NORECHARGES]    Script Date: 7/8/2021 6:54:56 AM ******/
SET ANSI_NULLS ON
GO
