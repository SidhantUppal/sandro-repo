<%@ Page language="c#" Codebehind="AddPaymentCardReceipt.aspx.cs" AutoEventWireup="false" Inherits="ASPNET_SDK_Samples.Samples.AddPaymentCardReceipt" %>
...
<body>
	<div id="wrapper">
		...
		<div id="response_form">
			<center><h3>Adaptive Accounts - Add Payment Card Response</h3></center><br/>
			<form id="Form1" method="post" runat="server">
				<table width="400" align="center">
					<tr>
						<td>Status:</td>
						<td><%= this.AddPaymentCardResponse.execStatus%></td>
					</tr>
					<tr>
						<td>Funding Source Key:</td>
						<td><%= this.AddPaymentCardResponse.fundingSourceKey%></td>
					</tr>
				</table>
			</form>
		</div>
