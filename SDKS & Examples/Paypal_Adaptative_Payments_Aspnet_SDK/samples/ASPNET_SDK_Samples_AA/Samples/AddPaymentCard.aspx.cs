...
{
    public class AddPaymentCard : System.Web.UI.Page
    {
        ...
        public void Submit_ServerClick(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                addPaymentCardRequest.webOptions = new WebOptionsType();
                string url = Request.Url.Scheme + "://" + Request.Url.Host + ":" + Request.Url.Port;
                string returnURL = url + ResolveUrl("AddPaymentCardReceipt.aspx");
                string cancelURL = url + ResolveUrl("AddPaymentCard.aspx");

                addPaymentCardRequest.webOptions.cancelUrl = cancelURL;
                addPaymentCardRequest.webOptions.cancelUrlDescription = "cancelURL";
                addPaymentCardRequest.webOptions.returnUrl = returnURL;
                ...
                else
                {
                    ...
                    Response.Redirect(AddPaymentCardResponse.redirectURL,false);
