<%@ Page language="c#" Codebehind="AddPaymentCardDirect.aspx.cs" AutoEventWireup="false" Inherits="ASPNET_SDK_Samples.Samples.AddPaymentCardDirect" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>PayPal SDK - Adaptive Accounts - Add Payment Card (Direct)</title>
	...
	function GenerateCreditCardNumber(){
		...
		switch(document.AddPaymentCardDirectForm.creditCardType.value)
        {
			case "Visa":
				cc_number[start++] = 4;
				break;
		...
		document.AddPaymentCardDirectForm.creditCardNumber.value = "";
		for (var k = 0; k < cc_len; k++) {
			document.AddPaymentCardDirectForm.creditCardNumber.value += cc_number[k];
		}
	}
...
<body onload ="javascript:GenerateCreditCardNumber(); return false;">
	<div id="wrapper">
		...
		<div id="request_form">
			<center><h3>Adaptive Accounts - Add Payment Card (Direct)</h3></center><br/>

			<form id="AddPaymentCardDirectForm" method="post" runat="server">	
				<table align="center">
	<tr>
    ...
    <tr>
        ...
        <td><input type="text" maxlength="50" ID="creditCardNumber" runat="server" value="4753221149290804" /></td>
    </tr>
     <tr>
    ...
    <tr>
        ...
        <td><input type="text" maxlength="50"
            name="lastName" value="Doe" id="lastName" runat="server" /></td>
    </tr>
	<tr>
    ...
    <tr>
        ...
        <td><input type="text" maxlength="50"
            name="cardVerificationNumber" value="956" id="cardVerificationNumber" runat="server" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="label">Create Account Key</td>
        <td><input type="text" maxlength="50"
            name="createAccountKey" value="" id="createAccountKey" runat="server" /></td>
    </tr>    
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" maxlength="50" name="address1"
            value="1 Main St" id="address1" runat="server" /></td>
    </tr>
    <tr>
        <td class="label">Address2</td>

        <td><input type="text" maxlength="50" name="address2"
            value="2nd cross" id="address2" runat="server" /></td>
    </tr>
    <tr>
        <td class="label">City</td>

        <td><input type="text" maxlength="50" name="city"
    ...
    <tr>
        ...
        <td><input type="text" maxlength="50" name="zipCode"
            value="78750" id="zipCode" runat="server" /></td>
   </tr>
    <tr>
        <td class="label">Country</td>
        <td><input type="text" maxlength="50" name="country"
