<%@ Page language="c#" Codebehind="AddBankAccountDirect.aspx.cs" AutoEventWireup="false" Inherits="ASPNET_SDK_Samples.Samples.AddBankAccountDirect" %>
...
<body>
    ...
    <tr>
        ...
        <td><input type="text" size="30" maxlength="50" name="createAccountKey" id="createAccountKey" runat="server" value="" /></td>
    </tr>
     <tr>
