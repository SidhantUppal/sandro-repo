...
namespace ASPNET_SDK_Samples.Samples
{
	...
	/// </summary>
	public class AddBankAccount : System.Web.UI.Page
	{
		...
		private void Submit_ServerClick(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                string cancelURL = url + ResolveUrl("AddBankAccount.aspx");
				...
				else
				{
                    ...
                    Response.Redirect(AddBankAccountResponse.redirectURL, false);
