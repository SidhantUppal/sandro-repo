...
{
	/// <summary>
	/// Summary description for SetPayParallel.
	/// </summary>
	public class SetPayParallel : System.Web.UI.Page
	{
		...
		private void Submit_ServerClick(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string cancelURL = url + ResolveUrl("SetPayParallel.aspx");
			...
			{
				FATALException FATALEx = new FATALException("Error occurred in SetPayParallel Page.", ex); 
				Session[Constants.SessionConstants.FATALEXCEPTION] = FATALEx ;
