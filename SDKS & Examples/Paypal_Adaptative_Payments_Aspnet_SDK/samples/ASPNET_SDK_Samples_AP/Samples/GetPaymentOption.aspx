<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetPaymentOption.aspx.cs" Inherits="ASPNET_SDK_Samples.Samples.GetPaymentOption" %>
...
<body>
	<div id="wrapper">
		...
		<div id="request_form">
			<center><h3>Adaptive Payments - Get Payment Options</h3></center><br/>
			<form id="Form1" method="post" runat="server">	

				<table align="center">											
					<tr>
						<td class="label" width="50">Pay Key **</td>
