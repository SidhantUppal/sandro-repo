<%@ Page language="c#" Codebehind="GetPaymentDetails.aspx.cs" AutoEventWireup="false" Inherits="ASPNET_SDK_Samples.Samples.GetPaymentDetails" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
<HEAD>
	<title>PayPal SDK - Adaptive Payments - Get Payment Details</title>
...
<body>
	<div id="wrapper">
		...
		<div id="request_form">
			<center><h3>Adaptive Payments - Get Payment Details</h3></center><br/>
			<form id="Form1" method="post" runat="server">
				<table align="center">
					<tr>
						...
						<td align="left">
							<input type="text" name="payKey" id="PayKey" runat="server"/>
						</td>
					</tr>
					<tr>
