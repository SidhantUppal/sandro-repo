...
{  
    ...
    public partial class ExecutePayment : System.Web.UI.Page
    {
         ...
         private void Submit_ServerClick(object sender, System.EventArgs e)
        {
            ...
            ExecutePaymentRequest executePayment = null;
            BaseAPIProfile profile2 = null;
            try
            {
                profile2 = (BaseAPIProfile)HttpContext.Current.Session[Constants.SessionConstants.PROFILE];
                executePayment = new ExecutePaymentRequest();
                executePayment.payKey = paykey.Value;
                executePayment.requestEnvelope = new RequestEnvelope();
                executePayment.requestEnvelope = ClientInfoUtil.getMyAppRequestEnvelope();
               
                PayPal.Platform.SDK.AdapativePayments ap = new PayPal.Platform.SDK.AdapativePayments();
                ap.APIProfile = profile2;
                ExecutePaymentResponse EPResponse = ap.ExecutePayment(executePayment);
                ...
                else
                {
                    ...
                    Session[Constants.SessionConstants.EXECUTEPAYMENTRESPONSE] = EPResponse;
                    this.Response.Redirect("ExecutePaymentReceipt.aspx", false);
                }
            }
