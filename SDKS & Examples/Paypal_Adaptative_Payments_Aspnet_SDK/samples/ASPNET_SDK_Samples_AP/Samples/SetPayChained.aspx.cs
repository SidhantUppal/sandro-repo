...
{
	/// <summary>
	/// Summary description for SetPayChained.
	/// </summary>
	public class SetPayChained : System.Web.UI.Page
	{
		...
		protected System.Web.UI.HtmlControls.HtmlInputText feesPayer;
		...
		protected System.Web.UI.HtmlControls.HtmlInputText primary_0;
		protected System.Web.UI.HtmlControls.HtmlInputText primary_1;
		...
		private void Submit_ServerClick(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string returnURL = url + ResolveUrl("PaymentDetails.aspx");
				string cancelURL = url + ResolveUrl("SetPayChained.aspx");
				...
				payRequest.feesPayer = feesPayer.Value ;
				payRequest.memo = memo.Value ;
				...
				payRequest.receiverList[0].primary = Boolean.Parse(primary_0.Value); 
				payRequest.receiverList[0].primarySpecified = true;
				...
				payRequest.receiverList[1].primary = Boolean.Parse(primary_1.Value);
				payRequest.receiverList[1].primarySpecified = true;
                ...
                else
                {
                    ...
                    {
                        HttpContext.Current.Response.Redirect("PaymentDetails.aspx?paykey=" + PResponse.payKey, false);
                    }
                    else
                    {
			...
			{
				FATALException FATALEx = new FATALException("Error occurred in SetPayChained Page.", ex); 
				Session[Constants.SessionConstants.FATALEXCEPTION] = FATALEx ;
