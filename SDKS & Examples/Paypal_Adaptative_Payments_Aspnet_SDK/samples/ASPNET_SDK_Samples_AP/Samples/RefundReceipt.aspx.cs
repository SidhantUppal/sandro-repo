...
namespace ASPNET_SDK_Samples.Samples
{
	...
	/// </summary>
	public class RefundReceipt : System.Web.UI.Page
	{
		...
		public RefundResponse RefundResponse
		{
			get
			{
				if(Session[Constants.SessionConstants.REFUNDRESPONSE] == null)
					return null;

				return (RefundResponse)Session[Constants.SessionConstants.REFUNDRESPONSE]; 
			}
