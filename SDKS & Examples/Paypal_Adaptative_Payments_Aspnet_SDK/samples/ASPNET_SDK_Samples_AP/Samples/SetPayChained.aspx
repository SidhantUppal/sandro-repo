<%@ Page language="c#" Codebehind="SetPayChained.aspx.cs" AutoEventWireup="false" Inherits="ASPNET_SDK_Samples.Samples.SetPayChained" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
<HEAD>
	<title>PayPal SDK - Adaptive Payments - Pay Chained</title>
...
<body>
	<div id="wrapper">
		...
		<div id="request_form">
			<center><h3>Adaptive Payments - Pay Chained</h3></center><br/>
			<form id="Form1" method="post" runat="server">
				<table align="center">
					...
					<tr>
						...
						<td><input type="text" maxlength="32" name="memo" id="memo" runat="server" value="chained"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="primary[0]" id="primary_0" runat="server" value="true" class="smallfield"></td>
					</tr>
					<tr>
						<td>
							<p align="center">2</p>
						</td>
						<td><input type="text" name="receiveremail[1]"  value="platfo_1255611349_biz@gmail.com" id="receiveremail_1" runat="server"></td>
								
						<td><input type="text" name="amount[1]" id="amount_1" maxlength="7" value="1.00" runat="server" class="smallfield"></td>
						<td><input type="text" name="primary[1]" id="primary_1" runat="server" value="false" class="smallfield"></td>
					</tr>
					<tr>
						<td colspan="4" align="right" class="note">** <i>Required field</i></td>
					</tr>					
					<tr>
					<td colspan='4'>NOTE: Chained payment requires one primary receiver, Please set one primary receiver to true</td></tr>
					<tr align="center">                    
