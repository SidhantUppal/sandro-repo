...
namespace ASPNET_SDK_Samples.Samples
{
    ...
    /// </summary>
    public class GetPreapprovalDetails : System.Web.UI.Page
    {
        ...
        private void Submit_ServerClick(object sender, System.EventArgs e)
        {
            try
            {
                Session[Constants.SessionConstants.PREAPPROVALKEY] = preapprovalkey.Value;
                string redirectPage = Constants.ASPXPages.PREAPPROVALDETAILS + "?" + Constants.QueryStringConstants.PREAPPROVALKEY + "=" + preapprovalkey.Value;
