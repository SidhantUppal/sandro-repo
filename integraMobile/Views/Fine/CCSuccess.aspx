		...
		<div id="form-win-container" class=" col-md-12 col-lg-10 p-4 mb-4">
			...
			<div id="form-win-resume" class="row p-2">
                ...
                <div class="col-12 text-center">
                    <% 
                    using (Html.BeginForm("CCSuccess", "Fine", FormMethod.Post))
                    { 
                    %>
            ...
            {
            %>
            <iframe src="SuccessMail" style="width:100%; height:500px; overflow:hidden; border:none;" scrolling="no"></iframe>
            <% 
            }
            %>
		</div>
