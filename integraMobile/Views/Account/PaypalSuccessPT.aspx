    ...
    <div class="row">
        <div class="col-md-12 col-block">
                ...
                <div class="alert alert-bky-success">
                    ...
                    <%=Resources.Account_RechargeSuccess_1%> <strong><%=string.Format(Resources.Account_Register_PaymentMeanMessage, string.Format(provider, "{0:0.00}", 
                    Convert.ToDouble( ViewData["PayerQuantity"].ToString())/100),ViewData["PayerCurrencyISOCode"]) %></strong>
                </div>
                ...
                <div class="row-buttons">
                    <a class="btn btn-primary" href="Main"><%=Resources.Account_Register_PaymentMeanRetry%></a>
                </div><!--//.row-buttons-->
        </div><!--//.col-block-->
    </div><!--//.row-->
</div><!--//.content-wrap-->
