    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            <div class="row">
                <div id="paper-top">
                    <div class="col-sm-12">
                        <h2 class="tittle-content-header"> Condiciones del Servicio                            y Términos de Uso</h2>
            ...
            <div class="content-wrap">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest">
                            <div class="title-alt">
                                <h6><span class="tittle-content-header"> <span>Condiciones del Servicio </span>y Términos de Uso</span></h6>
                            </div>

                            <div class="body-nest">
                              <h2>1. Titularidad del Portal</h2>
                              <p>En cumplimiento con lo establecido en el artículo 10 de la Ley 34/2002, de  11 de julio, de Servicios de la Sociedad de la Información y de Comercio  Electrónico, les informamos que el dominio www.Blinkay.com.mx es un dominio de  titularidad de <strong>Integr@ Soluciones de Parking S. de R.L de CV</strong> (en adelante, la Entidad), el  titular de este portal web (en adelante, el Portal). Su domicilio se encuentra  situado en la calle:</p>
                              <p>                                Integr@ Soluciones de Parking S. de R.L de CV<br>
                                Avda Gabriel Mancera #1041<br>
                                Col. Del Valle Centro 03100<br>
                                Delegación Benito Juárez, Distrito Federal<br>
                                +52 (55) 3687 2700<br>
                                <a href="mailto:Blinkay@integraparking.com">Blinkay@integraparking.com</a> <br>
                                <br>
                                <strong>La Entidad se encuentra inscrita en el Registro libro número un mil  trescientos veinte, instrumento número setenta y siete mil setecientos cuarenta  y siete.</strong> <br>
                                El(los) nombre(s) de dominio(s) a través del cual(es) Vd. ha accedido al  Portal es (son) titularidad de la Entidad.<br>
                                Dicho(s) nombre(s) de dominio(s) no podrá(n) ser utilizado(s) en conexión  con otros contenidos, productos o servicios que no sean titularidad de la  Entidad ni de ninguna manera que pueda causar confusión entre los usuarios  finales o el descrédito de la Entidad.<br>
                              El simple acceso a la Web y a cualquiera de sus páginas y aplicaciones  iPhone, Android, Blackberry, Windows Mobile e IVR (en adelante, las  &ldquo;Aplicaciones&rdquo;) atribuye la condición de usuario de la misma (en adelante, el  &quot;Usuario&quot;) e implica la aceptación plena y sin reservas de todas y cada  una de las condiciones incluidas en este Aviso Legal en la versión publicada  por la Entidad en el momento mismo en que el Usuario acceda a las Aplicaciones.</p>
                              <h2>2. Objeto</h2>
                              ...
                              <p>                                El mero acceso al Portal, la cumplimentación de formularios, el envío de  solicitudes de información, y, en general, cualquier acto de naturaleza similar  a los anteriores realizados a través de los formularios en el Portal implicará,  por su parte, la aceptación sin reservas de todas y cada una de las normas  integrantes del presente Aviso Legal y la adquisición de la consideración de  Usuario del Portal. En consecuencia, con anterioridad a la utilización de los  servicios descritos el Usuario debe leer atentamente el contenido del presente  Aviso Legal.</p>
                              <p>                                La utilización de ciertos servicios ofrecidos a los Usuarios a través de la  Web puede encontrarse sometida a condiciones particulares propias (en adelante,  las &quot;Condiciones Particulares&quot;) que, según los casos, sustituirán,  completarán y/o modificarán el presente Aviso Legal. Por lo tanto, con  anterioridad a la utilización de dichos servicios, el Usuario también ha de  leer atentamente las correspondientes Condiciones Particulares, indicadas en el  presente Aviso Legal.</p>
...
<ol>
                <li>Utilizarlos con fines o efectos contrarios  a la ley, a la moral, a las buenas costumbres generalmente aceptadas o al orden  público y a las instrucciones recibidas de la Entidad.</li>
...
<p>4. Responsabilidades y  Limitaciones</p>
<p>La Entidad no puede garantizar la fiabilidad, utilidad o veracidad de la  información que se preste a través del Portal.<br>
  En consecuencia, la Entidad no garantiza ni se hace responsable de:</p>
<ol>
  <li>La continuidad de los contenidos  del Portal y/o la falta de disponibilidad o accesibilidad del Portal o  continuidad técnica del mismo;</li>
  <li>La ausencia de errores en dichos  contenidos o productos;</li>
  <li>La ausencia de virus y demás  componentes dañinos en el Portal o en el servidor que lo suministra;</li>
  <li>La invulnerabilidad del Portal  y/o la inexpugnabilidad de las medidas de seguridad que se adopten en el mismo;</li>
  <li>En su caso, la falta de utilidad  o rendimiento de los contenidos o servicios del Portal;</li>
  <li>Los daños o perjuicios que cause,  a sí mismo o a un tercero, cualquier persona que infringiera las condiciones,  normas e instrucciones que la Entidad establece en el Portal o a través de la  vulneración de los sistemas de seguridad del mismo;</li>
  <li>Cualesquiera otros daños que  pudieran ser causados por motivos inherentes al no funcionamiento o al  funcionamiento defectuoso del Portal o de los sitios web a los que, en su caso,  se hayan podido establecer links.</li>
</ol>
...
<h2><strong>6. Enlaces</strong></h2>
<h3><strong>6.1 Enlaces desde el Portal a  otras páginas web.</strong></h3>
...
<h3><strong>6.2 Enlaces desde otras páginas  web al Portal.</strong></h3>
...
<ol>
  <li>Deberá recabar la autorización  previa, expresa y por escrito de la Entidad.</li>
  <li>El enlace solamente se podrá  dirigir a la página principal del Portal, salvo que expresamente se autorice  cosa distinta.</li>
...
<p>  El Usuario tiene  los derechos de  acceso, rectificación, cancelación y oposición (A.R.C.O), puede limitar el uso  y divulgación de sus datos, o bien, cuando sea posible, revocar el  consentimiento que haya otorgado para su tratamiento. Para conocer el  procedimiento mediante el cual podrá ejercer sus derechos, por favor lea  nuestro Aviso de Privacidad disponible en www.Blinkay.com.mx/avisolegal.html  antes de proporcionar cualquier dato personal.</p>
<h2>8. Condiciones Particulares de  Uso de la Aplicación de Pago por Móvil</h2>
<p>  La Entidad ha desarrollado un servicio que facilita la compra de tickets  electrónicos de estacionamiento mediante Aplicaciones y lo pone a disposición  de las municipalidades que deseen implantarlo. Dicho servicio se podrá utilizar  en cualquier ciudad donde esté implantado nuestro servicio de cobro. El usuario  puede utilizar el servicio de forma inmediata sin o con previo registro, de  acuerdo con las condiciones publicadas en <a href="http://www.Blinkay.com.mx"><strong><em>www.Blinkay.com.mx</em></strong></a>. </p>
<p>El importe de los tickets  electrónicos y, en su caso, el coste del servicio se carga en la factura móvil  del usuario o contra el saldo de su cuenta virtual de la plataforma <strong><em>Blinkay</em></strong>.  El usuario, al estacionar en la vía pública y al utilizar el servicio de  Entidad, se obliga a respetar las ordenanzas municipales. Los vigilantes de la  zona pueden verificar la existencia de un ticket electrónico válido mediante  terminales introduciendo la matrícula. La Entidad es responsable de abonar los  importes pagados a las empresas concesionarias. La disponibilidad del servicio  depende de la disponibilidad de las redes de telecomunicaciones, la Entidad no  se responsabiliza de los daños y perjuicios que pudieran derivarse del uso de  las Aplicaciones.</p>
<h3>I. Cierre de Contrato</h3>
...
<p><strong>III. Obligación de pago</strong></p>
<p>  El cliente es responsable del pago de los gastos incurridos por el uso del  servicio, los gastos para los tickets electrónicos de estacionamiento comprados  y los gastos del servicio prestado por la Entidad. La responsabilidad se  extiende también al posible uso del servicio por terceros autorizados o no  autorizados por el cliente.</p>
<p>  El cliente podrá recibir mensualmente documento justificativo del pago con  desglose del importe de los tickets electrónicos y, en su caso, del coste de  servicio. Dicho documento identificará todas las transacciones con los  siguientes datos: número móvil, zona de estacionamiento, tiempo aparcado y el  importe.</p>
<p>  En caso de no cumplir con la obligación de pago la Entidad suspenderá de  forma inmediata el servicio. Antes de reactivar el servicio el usuario ha de  realizar un pago vía transferencia bancaria o registrándose con una tarjeta de  crédito/débito válida. En el caso de no ser posible cobrar el importe la  Entidad tomará las medidas legales oportunas.</p>
<p>  Al optar por el método de prepago el usuario se obliga a mantener el saldo  de su cuenta bancaria en positivo para poder operar así como mantener una  tarjeta bancaria válida que permita el cargo mensual del coste del servicio. Por  cada devolución que se produzca la Entidad aplicará una penalización de 100  (cien) pesos mexicanos en concepto de gestión de la devolución.</p>
<p>  La Entidad es responsable del saldo vivo remanente y en caso de cancelación  del servicio procederá a su devolución por el mismo canal por el que se gestionó  la transacción. </p>
<h3>IV. Forma de pago</h3>
<ul>
  <li>Prepago – tarjeta de crédito</li>
  </ul>
<p>Al registrarse con una tarjeta de crédito/débito y cada vez que se cambia o  actualiza la información de la tarjeta se realiza un cargo de 1 (un) peso  mexicano que se abona a la cuenta virtual de la Entidad. Con esta transacción  se verifica si los datos de la tarjeta son correctos y que la tarjeta es  activa. </p>
<p>  En el caso  de pago mediante tarjeta de crédito el cliente autoriza a la Entidad a realizar  el cargo por el servicio mensualmente y a poder aplicar en el mismo un eventual  incremento del IPC.</p>
<h3>V. Precios</h3>
<p>  El usuario paga la tasa o precio público de estacionamiento de acuerdo con  las tarifas vigentes reguladas en las ordenanzas del ayuntamiento para cada  zona. Dependiendo de la ciudad puede que el usuario también pague la tarifa de  servicio de la Entidad que se publica en la página web en el apartado  &ldquo;Localidades&rdquo; para cada ciudad, en las aplicaciones y/o en los medios de  comunicación (vinilos, trípticos).</p>
<h3>VI. Responsabilidades</h3>
<p>  La prestación del servicio depende de la disponibilidad de la red de  telecomunicación en el momento de iniciar el estacionamiento. La misma  condición se aplica en el momento de terminar el estacionamiento al usar el  mecanismo &ldquo;start/stop&rdquo; o la opción &ldquo;desaparcar&rdquo;, en el caso de que las mismas  estuvieran implantadas. Al no estar disponible el servicio el usuario está  obligado a utilizar un modo de pago alternativo ofrecido por la Empresa  Concesionaria. El usuario tiene la obligación de comprobar, si las  transacciones han finalizado correctamente. En el caso de usar el canal de  llamada recibirá la confirmación del sistema interactivo vía voz y en el canal  www o aplicaciones iPhone/Android/Blackberry/Windows Mobile será redirigido a  una página que confirma la finalización exitosa de la transacción.</p>
...
<p>  El usuario es responsable de introducir correctamente los datos de la zona  donde quiere estacionar, la matrícula y la hora de salida. La introducción de  la matrícula, de la zona y de la hora no perjudica el derecho de la Empresa  Concesionaria de expedir una multa. La Entidad no se hará responsable de  posibles daños y perjuicios por el uso indebido del servicio.</p>
<p><strong>VII. Duración y Modificación</strong></p>
...
<p><strong>VIII. Comunicaciones</strong></p>
...
<p><strong>IX. Otras Previsiones</strong></p>
<p>  Los encabezamientos de las distintas cláusulas son sólo informativos, y no  afectarán, calificarán o modificarán la interpretación del Aviso Legal.<br>
  En caso de existir discrepancia entre lo establecido en este Aviso Legal y  las condiciones particulares que, en su caso, puedan ser establecidas respecto  de los productos o servicios ofrecidos en el Portal, prevalecerá lo dispuesto  en las condiciones particulares.</p>
...
<p><strong>X. Legislación Aplicable y  Tribunales Competentes</strong></p>
...
<p>  Integr@ Soluciones de Parking una compañía de  Integr@ Parking Solutions Inc.<br>
  <em>Todos los derechos reservados - © 2015</em>&nbsp;<br>
