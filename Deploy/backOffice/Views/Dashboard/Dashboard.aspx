...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%= Resources.Dashboard_Title %>
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <link href="<%= Url.Content("~/Content/dashboard.css?v1.0") %>" rel="stylesheet" type="text/css" />
                                    ...
                                    <td>
                                        <%= Html.Kendo().DropDownList()
                                              ...
                                              .DataSource(source => {
                                                  source.Read(read =>
                                                  {
                                                      read.Action("GetDateGroupTypes", "Dashboard");
                                                  }); 
                                              })
                                    ...
                                    <td>
                                        ...
                                        <%= Html.Kendo().DropDownList()
                                                ...
                                                .DataSource(source => {
                                                    source.Read(read =>
                                                    {
                                                        read.Action("GetDateFilterTypes", "Dashboard");
                                                    }); 
                                                })
                                    ...
                                    <td>
                                        <%= Html.Kendo().DropDownListFor(m => m.CurrencyId)
                                                    ...
                                                    .DataSource(source => {
                                                        source.Read(read =>
                                                        {
                                                            read.Action("GetCurrencies", "Dashboard");
                                                        }); 
                                                    })
                                ...
                                <div class="editor-field">
                                   <%= Html.Kendo().MultiSelect()
                                           ...
                                           .DataSource(source => {
                                              source.Read(read =>
                                              {
                                                  read.Action("Read_TreeGroups", "Dashboard", new { id = "" });
                                              })
                                    ...
                                    contentPanes.Add()
                                        ...
                                        .Content(() => { %>
                                            <div class="pane-content" style="height: 98%;">
                                                <h3><%= Resources.Dashboard_TreeTitle %></h3>
                                                <% Html.Kendo().TreeView()
                                                    ...
                                                    .DataSource(dataSource => dataSource
                                                        .Read(read => read
                                                            .Action("Read_TreeGroups", "Dashboard")
                                                        )                                            
                                                    )
                                                    /*.Events(events =>
                                                        events.Select("OnTreeInstallationsSelect")
                                                                .Change("OnTreeInstallationsChange")
                                                                .DataBound("OnTreeInstallationsDataBound")
                                                    )*/
                                                    .Render();
                                                %>                    
                                            </div>
                                        ...
                                        .Content(() => { %>
                                            ...
                                            <div class="pane-charts" style="height: 99%;">
                                                ...
                                                <% Html.Kendo().TabStrip()
                                                    ...
                                                    .Items(tabstrip =>
                                                    {
                                                        tabstrip.Add().Text(Resources.Dashboard_TabToday_Text)
                                                            .Selected(true)
                                                            .HtmlAttributes(new {id = "tabToday", tabIndex = 0})
                                                            .Content(() => 
                                                            { %>
                                                                <div class="pane-content" style="height: 100%;">
                                                                    <% Html.RenderPartial("~/Views/Dashboard/TodayCharts.ascx", Model); %>
                                                                </div>                                                       
                                                        <% });

                                                        tabstrip.Add().Text(Resources.Dashboard_TabOperations_Text)                                                            
                                                            .HtmlAttributes(new {id = "tabOperations", tabIndex = 1})
                                                            .Content(() => 
                                                            { %>
                                                                <div class="pane-content" style="height: 100%;">
                                                                    <% Html.RenderPartial("~/Views/Dashboard/OperationsCharts.ascx", Model); %>
                                                                </div>                                                       
                                                        <% });
                                                                                                   
                                                        tabstrip.Add().Text(Resources.Dashboard_TabRecharges_Text)
                                                            .HtmlAttributes(new { id = "tabRecharges", tabIndex = 2 })
                                                            .Content(() => { %>
                                                                <div class="pane-charts" style="height: 100%;">                                                        
                                                                    <% Html.RenderPartial("~/Views/Dashboard/RechargesCharts.ascx", Model); %>
                                                                </div>
                                                        <% });

                                                        tabstrip.Add().Text(Resources.Dashboard_TabInscriptions_Text)
                                                            .HtmlAttributes(new { id = "tabInscriptions", tabIndex = 3 })
                                                            .Content(() => { %>
                                                                <div class="pane-charts" style="height: 100%;">
                                                                    <% Html.RenderPartial("~/Views/Dashboard/InscriptionsCharts.ascx", Model); %>
                                                                </div>
                                                        <% });
                                   
                                                        tabstrip.Add().Text(Resources.Dashboard_TabSystemUse_Text)                                    
                                                            .HtmlAttributes(new {id = "tabSystemUse", tabIndex = 4})
                                                            .Content(() => 
                                                            { %>
                                                                <div class="pane-content" style="height: 100%;">
                                                                    <% Html.RenderPartial("~/Views/Dashboard/SystemUseCharts.ascx", Model); %>
                                                                </div>                                                       
                                                        <% });
        ...
        function NotifyRefresh() {
            if (dashboard.noty == null) {
                dashboard.noty = $("#divNotify").noty({
                    text        : "<%= Resources.Dashboard_FilterNotify_Text %>",
                    type        : "information",
                    dismissQueue: true,
                    layout      : "topCenter",
                    theme       : 'defaultTheme',
                    maxVisible  : 30,
                    buttons     : [
                        {addClass: 'btn btn-primary k-button', text: '<%= Resources.Dashboard_FilterNotify_ApplyButton %>', onClick: function ($noty) {
                            $noty.close();
                            dashboard.noty = null;
                            ChartsRefresh();
                        ...
                        {addClass: 'btn btn-danger k-button', text: '<%= Resources.Dashboard_FilterNotify_CancelButton %>', onClick: function ($noty) {
                            $noty.close();
                            dashboard.noty = null;
