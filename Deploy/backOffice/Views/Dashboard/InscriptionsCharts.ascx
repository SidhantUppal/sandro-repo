            ...
            <div class="pane-content" style="height: 100%;">
                ...
                <%= Html.Kendo().Chart<ChartDataItem>()
                        ...
                        .Series(series =>
                        {
                            ...
                            series.Column(model => model.Serie0).Name(Resources.Dashboard_SerieInscriptionsCount)
                                                                .Axis("countAxis");
                        ...
                        .ValueAxis(axis => axis
                            .Numeric("countAxis")
                            .Title(Resources.Dashboard_YAxisCountInscriptions)
        ...
        .Content(() => { %>                                                                                
			<div class="pane-content" style="height: 100%;">
                ...
                <%= Html.Kendo().Chart<ChartDataItem>()
                        ...
                        .Series(series =>
                        {
                            series.Column(model => model.Serie0).Name(Resources.Dashboard_Serie1InscriptionAmountAvg)
                            ...
                            series.Column(model => model.Serie1).Name(Resources.Dashboard_Serie2InscriptionAmountAvg)
                                                                .Axis("amountAxis")//.Stack("amount")
                                                                .Tooltip(tooltip => tooltip.Template("#= series.name #<br>#= kendo.toString(value, 'n2') # #=dashboard.filters.CurrencyIsoCode#"));
                        })
                        .CategoryAxis(axis => axis
