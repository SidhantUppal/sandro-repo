                ...
                .Content(() => { %>
                    <div class="pane-content" style="height: 100%;">
                        ...
                        //.Title("Operations"
                                ...
                                .Series(series =>
                                {                                                                                                                                                                                                
                                    //series.Column(model => model.Serie0).Name(Resources.Dashboard_SerieOperationsAmountAvg)
                                    //                                    .Axis("amountAxis").Stack("amountTotal")
                                    //                                    .Tooltip(tooltip => tooltip.Template("#= series.name #: #= kendo.toString(value, 'n2') #€"));
                                    series.Column(model => model.Serie0).Name(Resources.Dashboard_SerieParkingOperationsAmountAvg)
                                    ...
                                    series.Column(model => model.Serie2).Name(Resources.Dashboard_SerieExtensionOperationsAmountAvg)
                                                                        .Axis("amountAxis").Stack("amount")
                                                                        .Tooltip(tooltip => tooltip.Template("#= series.name #<br>#= kendo.toString(value, 'n2') # #= dashboard.filters.CurrencyIsoCode#"));
                                    series.Column(model => model.Serie4).Name(Resources.Dashboard_SerieParkingRefundsAmountAvg)
                                                                        .Axis("amountAxis").Stack("amount")
                                                                        .Tooltip(tooltip => tooltip.Template("#= series.name #<br>#= kendo.toString(value, 'n2') # #= dashboard.filters.CurrencyIsoCode#"));
                                                                                                
                                    series.Line(model => model.Serie1).Name(Resources.Dashboard_SerieParkingOperationsTimeAvg)
                                                                        .Axis("timeAxis")//.Stack("time")
                                                                        .Tooltip(tooltip => tooltip.Template("#= series.name #<br>#= minutes2String(value) #")).Width(1);
                                    series.Line(model => model.Serie3).Name(Resources.Dashboard_SerieExtensionOperationsTimeAvg)
                                                                        .Axis("timeAxis")//.Stack("time")
                                                                        .Tooltip(tooltip => tooltip.Template("#= series.name #<br>#= minutes2String(value) #")).Width(1);
                                    series.Line(model => model.Serie5).Name(Resources.Dashboard_SerieParkingRefunsTimeAvg)
                                                                        .Axis("timeAxis")//.Stack("time")
                                                                        .Tooltip(tooltip => tooltip.Template("#= series.name #<br>#= minutes2String(value) #")).Width(1);
                                ...
                                .ValueAxis/*ValueAxis*/(axis => axis
                                    .Numeric("timeAxis")
                                    .Title(Resources.Dashboard_YAxisTimeAvg)
