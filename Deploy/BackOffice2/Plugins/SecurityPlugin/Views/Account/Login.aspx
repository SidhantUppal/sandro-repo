<%@ Page Language="C#" MasterPageFile="~/Plugins/SecurityPlugin/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<SecurityPlugin.Models.LoginModel>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <link href="<%= Url.Content(RouteConfig.BasePath + "Content/Login.css?v1.0") %>" rel="stylesheet" type="text/css" />    

</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

   <% using (Html.BeginForm("Login", "Account", FormMethod.Post, new { plugin = "SecurityPlugin", autocomplete = "off" }))
      { %>  
        ...
        <div class="login-container">
            ...
            <div id="viaLogin">
                <img src="<%= Url.Content(RouteConfig.BasePath + "Content/images/login/headerLeft.png") %>" />
                <span id="spanTitleLogin"><%= resBundleBackOffice.GetString("backOffice", "Main.BackOffice.Title", "CONTROL CENTER") %></span>
                <div id="meyparLogin">
                    <img src="<%= Url.Content(RouteConfig.BasePath + "Content/images/login/logo_meypar_via_login.png") %>" />
                </div>
            </div>
            <!-- header login !-->
            ...
            <div class="login-field">
                <%: /*Html.TextBoxFor(m => m.UserName, new { autocomplete = "off", tabindex = 1, @class = "k-input k-textbox" })*/
                    Html.TextBoxFor(m => m.UserName, new Dictionary<string, Object> { { "autocomplete", "off" }, { "tabindex", "1" }, { "class", "k-input k-textbox" }, { "data-val-required", resBundleBackOffice.GetString("Common", "Default.Field.Required2", "Field required") } })
                    %>
            ...
            <div class="login-field">
                <%: Html.PasswordFor(m => m.Password, new Dictionary<string, Object> { { "autocomplete", "off" }, { "tabindex", "2" }, { "class", "k-input k-textbox" }, { "data-val-required", resBundleBackOffice.GetString("Common", "Default.Field.Required2", "Field required") } }) %>
