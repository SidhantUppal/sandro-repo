...
(function(trv, $) {
    ...
    var sr = {
        ...
        invalidParameter: "Inserte un valor válido.",
        invalidDateTimeValue: "Inserte una fecha válida.",
        ...
        preparingDownload: "Preparando el documento para su descarga. Espere por favor ...",
        preparingPrint: "Preparando el documento para imprimir. Espere por favor ...",
        errorLoadingTemplates: "Error cargando las plantillas del visor de informes.",
        loadingReportPagesInProgress: "{0} páginas cargadas ...",
        loadedReportPagesComplete: "Hecho. Total {0} páginas cargadas.",
        noPageToDisplay: "No hay página a mostrar.",
        errorDeletingReportInstance: "Error eliminando la instancia del informe: {0}",
        ...
        unableToGetReportParameters: "Imposible obtener los parámetros del informe.",
		missingParameters: "Introduzca los valores de los parámetros del informe."
    };
