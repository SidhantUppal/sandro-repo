/*
* TelerikReporting v9.2.15.1126 (http://www.telerik.com/products/reporting.aspx)
    ...
    function ParametersArea(placeholder, options, otherOptions) {
        ...
        function loadParameters(parameterValues, successAction) {
            ...
            $.when(controller.loadParameters(parameterValues)).done(function(parameters) {
                var needsParamsArea = hasVisibleParameters(parameters) && options.parametersAreaVisible !== false;
                if (!needsParamsArea) {
...
(function(trv, $, window, document, undefined) {
    ...
    function ReportViewer(dom, options) {
        ...
        function initFromStorage() {
            ...
            controller.setDocumentMapVisible({
                documentMapVisible: dm ? dm : options.documentMapVisible
            });
            controller.setParametersAreaVisible({
                parametersAreaVisible: pa ? pa : options.parametersAreaVisible
            });
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM 93D69785B179844A304549825C821A30 */