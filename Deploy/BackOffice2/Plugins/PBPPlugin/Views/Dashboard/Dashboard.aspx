...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <link href="<%= Url.Content(RouteConfig.BasePath + "Content/dashboard.css?v1.1") %>" rel="stylesheet" type="text/css" />
                                                ...
                                                <% Html.Kendo().TabStrip()
                                                    ...
                                                    .Items(tabstrip =>
                                                    {
                                                        ...
                                                        tabstrip.Add().Text(resBundle.GetString("PBPPlugin", "Dashboard_TabSystemUse_Text"))                                    
                                                            .HtmlAttributes(new {id = "tabSystemUse", tabIndex = 5})
                                                            .Content(() => 
                                                            { %>
                                                                <div class="pane-content" style="height: 100%;">
                                                        ...
                                                        tabstrip.Add().Text(resBundle.GetString("PBPPlugin", "Dashboard_TabInvitations_Text"))                                                            
                                                            .HtmlAttributes(new {id = "tabInvitations", tabIndex = 6})
                                                            .Content(() => 
                                                            { %>
                                                                <div class="pane-content" style="height: 100%;">
                                                        ...
                                                        tabstrip.Add().Text(resBundle.GetString("PBPPlugin", "Dashboard_TabRechargeCoupons_Text"))                                                            
                                                            .HtmlAttributes(new {id = "tabRechargeCoupons", tabIndex = 7})
                                                            .Content(() => 
                                                            { %>
                                                                <div class="pane-content" style="height: 100%;">
