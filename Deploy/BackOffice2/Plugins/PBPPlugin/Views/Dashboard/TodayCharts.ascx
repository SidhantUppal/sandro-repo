                    ...
                    <table border="0" style="width:100%;">
                        <tr>
                            <td colspan="3" class="openum-title-container">
                                <span id="spanParkingsTitle" class="equal"><%= resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ParkingOperation.ToString()) %></span>
                            </td>
                            <td colspan="3" class="openum-title-container">
                                <span id="spanExtensionsTitle" class="equal"><%= resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ExtensionOperation.ToString()) %></span>
                            </td>
                            <td colspan="3" class="openum-title-container">
                                <span id="spanRefundsTitle" class="equal"><%= resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ParkingRefund.ToString()) %></span>
                            </td>
                            <td colspan="3" class="openum-title-container">
                                <span id="spanTicketsTitle" class="equal"><%= resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.TicketPayment.ToString()) %></span>
                            </td>
                            <td colspan="3" class="openum-title-container">
                                <span id="spanRechargesTitle" class="equal"><%= resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.BalanceRecharge.ToString()) %></span>
                            </td>
                            ...
                            %>
                                <td colspan="3" class="openum-chart">
                                    <%= Html.Kendo().Sparkline<TodayData>()
                                            ...
                                            .DataSource(ds => 
                                            {
                                                ds.Read(read => read.Action("Read_Today", "Dashboard", new { plugin = "PBPPlugin"} ));
                                                ds.Events(events =>
                                                {
            ...
            .Content(() => { %>
                <div class="pane-content" style="height: 96%;">
                    <%= Html.Kendo().Chart<ChartDataItem>()
                            ...
                            .DataSource(ds => 
                            {
                                ds.Read(read => read.Action("Read_OperationsToday", "Dashboard", new { plugin = "PBPPlugin" }));
                                ds.Events(events =>
                                {
