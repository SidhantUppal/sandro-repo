...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <link href="<%= Url.Content("~/Content/kendo/kendo.blinkay.css?v1.0") %>" rel="stylesheet" type="text/css" />
...
<% 
    ...
    { 
        ...
        <div class="content-wrap">
            <div id="permits-errors" class="row">
            ...
            <div id="permits-steps" class="row">
                <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-12">     
                    <% 
                        if (Model.FromLogin == true) 
                        { 
                            %>
                            <%-- // old if Model.FromLogin
                    ...
                    %>
                </div><!--//.col-md-12.col-block-->
            </div><!--//#permits-steps.row-->
            <div id="permits-content" class="row">
                <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-12 col-block content">
                    <h3 class="content-header"><span><% if (Model.FromLogin == false) { %>2<% } else { %>1<% } %>.</span> <%= resBundle.GetString("Permits_PayForPermit")%></h3>
                    <hr>
                    <div class="form-group">
                        <%-- <label><% =resBundle.GetString("PermitsDataModel_City") %></label> --%>
                        <%= Html.Label("City", resBundle.GetString("PermitsDataModel_City"))%>
                    ...
                    <div class="form-group">
                        ...
                        <%= Html.Label("Zone", resBundle.GetString("PermitsDataModel_Zone"))%>
                        <%= Html.Kendo().DropDownList()
                            .Name("Zone")
                            .HtmlAttributes(new { style = "" })
                            .DataTextField("Name")
                    ...
                    <div class="form-group">
                        ...
                        <%= Html.Label("Month", resBundle.GetString("PermitsDataModel_Month"))%>
                        <%= Html.Kendo().DropDownList()
                            .Name("Month")
                            .HtmlAttributes(new { style="" })
                            .DataTextField("Name")
                    ...
                    <div class="form-group">
                        ...
                        <%= Html.Label("Tariff", resBundle.GetString("PermitsDataModel_Tariff"))%>
                        <%= Html.Kendo().DropDownList()
                            .Name("Tariff")
                            .HtmlAttributes(new { style = "" })
                            .DataTextField("Name")
                    ...
                    <div class="form-group">
                        ...
                        <%= Html.Label("NumPermits", resBundle.GetString("Permits_NumPermits") )%>
                        <%= Html.Kendo().DropDownList()
                            .Name("NumPermits")
                            .HtmlAttributes(new { style = "" })
                            .DataTextField("Name")
                    ...
                    <div class="form-group">
                        ...
                        <%= Html.Label( "TimeStep" , resBundle.GetString("PermitsDataModel_TimeStep")) %>
                        <%= Html.Kendo().DropDownList()
                            .Name("TimeStep")
                            .HtmlAttributes(new { style = "" })
                            .DataTextField("text")
                    ...
                    <div class="alert alert-bky-info" >
                        <span class="bky-info"></span> &nbsp; <% =resBundle.GetString("Permits_Automatic_Renewal_Description") %>
                    </div>
                    <div class="row-buttons submit-button-little">
                ...
                </div><!--//.col-lg-8.col-lg-offset-2.col-md-12.col-block -->
            </div><!--//#permits-content.row-->
        </div><!--//.content-wrap-->
        <% 
    } // Html.BeginForm
%>
    <script type="text/javascript">
            ...
            if ($("#Tariff").val() != null) {
                for (i = 0; i < $("#Tariff").data().kendoDropDownList.dataSource._data.length; i++) {
                    if ($("#Tariff").data().kendoDropDownList.dataSource._data[i].id == $("#Tariff").val()) {
                        ...
                        for (x = 1; x <= NumPermits; x++)
                        {
                            // We show as much plate fields as defined by tariff, for each one of the blocks
                            for (j = 1; j <= MaxLicensePlates; j++) {
                                $("#PlateField" + x + "_" + j).css("display", "block");
                                $('#LicensePlate'+x + "_" + j).data("kendoLicensePlate"+x + "_" + j).dataSource.read();
                                $('#LicensePlate'+x + "_" + j).data("kendoLicensePlate"+x + "_" + j).enable(true);
                            }
                            // We hide the others
                            for (j = (MaxLicensePlates + 1) ; j <= 10; j++) {
                                $("#PlateField" + x + "_" + j).css("display", "none");
                            }                        
                        }
                    }
                }
        ...
        function LoadPlateGroups() {
            ...
            for (i = 1; i <= NumPermits; i++)
            {
                $("#PermitGroups").append("<hr>");
                $("#PermitGroups").append("<div class='PermitGroup'><h3><%=resBundle.GetString("Permits_Permit") %> " + i + "</h3></div>");
                $("#PermitGroups").append("<p class='alert alert-info h5'><span class='bky-info'></span> &nbsp; <%=resBundle.GetString("Permits_OnlyOne") %></p>");
                ...
                for (j = 1; j <= 10; j++)
                {
                    ...
                    $("#PermitGroups").append("<div class='form-group' id='PlateField" + i + "_" + j + "'><label for='LicensePlate" + i + "_" + j +"'><% =resBundle.GetString("PermitsDataModel_Plate") %> " + j + "</label><div id='LicensePlate" + i + "_" + j + "' name='LicensePlate" + i + "_" + j + "' ></div><input type='hidden' name='LP" + i + "_" + j + "' id='LP" + i + "_" + j + "'></div>");
