...
<div id="page-content">
	<div id="form-win-container" class=" container-xl">
		...
		<!-- STEPS -->
		<div id="form-win-steps" class="row justify-content-center">
			...
			<div class="col">
				...
				<div class="row justify-content-center">
					<div class="col col-lg-4">
		 				<button class="btn btn-primary btn-block p-3" type="button" onclick="location.href = 'Fine';"><%=Resources.Fine_SearchButton%></button>
					</div><%-- // .col --%>
				</div><%-- // .row .justify-content-center --%>
			</div><%-- // .form-win-container.col --%>
		</div><%-- // .form-win-container.row --%>
