...
<div id="page-content">
	<div id="form-win-container" class=" container-xl">
		...
		<div id="form-win-steps" class="row">
			...
			<div class="col form-step form-step-selected"><%=Resources.Fine_PaymentDone%></div>
		</div>
		<%-- // END STEPS  --%>
		...
		<div id="form-win-intro" class="row">
			<div class="col-12 ">
				<p class="text-center my-3">
					...
					<%=Resources.Fine_TicketPaymentOK%>
				</p>
			</div>
		</div>
		...
		<!-- FORM CONTENT --->
		<!-- TABLE RESUME-->
		<div class="form-content col-12 col-lg-8 p-0 align-self-center">
		...
		</div><%-- // .form-content col-12 col-lg-8 p-0 align-self-center--%>
		...
		<% if (Session["strRechargeEmailSubject"] != null && Session["strRechargeEmailBody"] != null) {
			%>
				<iframe src="SuccessMail" style="width:100%; height:300px; overflow:hidden; border:none;" scrolling="no"></iframe>
			<% 
		} // endif Session["strRechargeEmailSubject"] %>
	</div><%-- // form-win-container.container-xl --%>
</div>
