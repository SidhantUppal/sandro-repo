...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%=Resources.Account_Recharge_PaymentsWithPreapproval%>
</asp:Content>
...
<div id="breadcrumb-wrapper" class="row">
    <ul id="breadcrumb">
        ...
        <li><%=Resources.Account_Recharge_PaymentsWithPreapproval%>
        </li>
    </ul>
</div>
--%>
    ...
    <div class="row">
        <div class="col-md-12 col-block">
                ...
                <div class="alert alert-bky-success">
                    ...
                    &nbsp;
                    <%=Resources.Account_Recharge_PaymentsWithPreaproval_1%> 
                    &nbsp;
                    ...
                    <%
                        ...
                        { 
                            %>
                                ...
                                &nbsp;
                                <strong><%=Resources.Account_Recharge_PaymentsWithPreaproval_2%></strong>
                                <hr>
                ...
                <div class="row-buttons">
                    <a class="btn btn-bky-primary" href="<%= Url.Action("PaypalPreapprovalPayRedirectINT", "Account") %>"><%=Resources.Account_RechargeButton_Recharge%></a>
                    <%
                        if (Convert.ToDouble(ViewData["UserBalance"])>0) 
                        { 
                            %>
