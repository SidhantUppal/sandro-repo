...
<div class="title-alt">
 ...
 --%>
<% 
using (Html.BeginForm("SelectPayMethodINT", "Account", FormMethod.Post, new {@id = "FormSelectPayMethod", @name = "FormSelectPayMethod", @role = "form"}))
{
    %> 
                    ...
                    <%
                        ...
                        { 
                            %>
                                ...
                                <div class="form-group">
                                    <p class="help-block"><%=Resources.SelectPayMethod_IntroText3 %></p>
                                ...
                                <div class="form-group">
                                    <div class="alert alert-bky-info">
                                        ...
                                        <ul>
                                            ...
                                            <li><%=Resources.SelectPayMethod_Sus_Remark3 %>
                                                <ol>
                                        ...
                                        <p><%=Resources.SelectPayMethod_Sus_Remark6 %></p>
