                    ...
                    <div class="col-sm-12">
                            <h3><%=Resources.Account_RechargeSuccessTitle%></h3>
                                ...
                                <div class="alert alert-bky-success">
                                    ...
                                    &nbsp;
                                    <%=Resources.Account_RechargeSuccess_1%> <strong><%=string.Format(provider, "{0:0.00} {1}", Convert.ToDouble(ViewData["UserBalance"].ToString(), provider) / 100.0, ViewData["PayerCurrencyISOCode"])%></strong>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-block">
                            <h3><%=Resources.Account_RechargeFailureTitle%></h3>
                                ...
                                <div class="alert alert-bky-danger">
                                    <strong><span class="bky-info"></span> <%=j.errorMessage%></strong>
                                </div>
