...
<li class="f16">
    <a href="<%= Url.Action("ChangeCulture", "Home",  new { lang = "en-US", returnUrl = "#" } ) %>" >
...
<li class="f16">
    <a href="<%= Url.Action("ChangeCulture", "Home",  new { lang = "fr-CA", returnUrl = "#" }) %>">
        <span class="flag-icon ca"></span>  Français
    </a>
</li>
<li class="f16">
    <a href="<%= Url.Action("ChangeCulture", "Home",  new { lang = "ca-ES", returnUrl = "#" }) %>">
