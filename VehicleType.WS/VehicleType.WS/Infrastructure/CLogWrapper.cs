...
namespace VehicleType.WS.Infrastructure.Logging.Tools
{
    ...
    public class CLogWrapper
    {
        ...
        public void LogMessage(LogLevels nLevel, string strMethodName, string strMessage)
        {
            strMessage = string.Format("{0}.{1} -> {2}", m_sTypeName, strMethodName, strMessage);
