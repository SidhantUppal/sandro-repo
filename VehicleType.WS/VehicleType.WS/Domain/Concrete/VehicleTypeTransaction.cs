...
{
    public class VehicleTypeTransaction : IVehicleTypeTransaction 
    {
        ...
        public VehicleTypeTransaction(bool bStateless)
        {
        ...
        public VehicleTypeTransaction(NHSessionManager.ConnectionConfiguration oConnectionConfig, bool bStateless)
        {
            _stateless = bStateless;
        ...
        public VehicleTypeTransaction(ISession oSession)
        {
            _stateless = false;
            Session = oSession;
        }
        public VehicleTypeTransaction(ISession oSession, ITransaction oTransaction)
        {
            _stateless = false;
            Session = oSession;
            Transaction = oTransaction;
        }
        public VehicleTypeTransaction(IStatelessSession oStatelessSession)
        {
            _stateless = true;
            StatelessSession = oStatelessSession;
        }
        public VehicleTypeTransaction(IStatelessSession oStatelessSession, ITransaction oTransaction)
        {
            _stateless = true;
            StatelessSession = oStatelessSession;
            Transaction = oTransaction;
