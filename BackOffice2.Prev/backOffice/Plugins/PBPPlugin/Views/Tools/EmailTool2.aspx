<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<backOffice.Models.EmailToolDataModel>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    ...
    <%= resBundle.GetString("PBPPlugin", "EmailTool_Title", "Email tool") %>
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <link href="<%= Url.Content(RouteConfig.BasePath + "Content/emailTool.css") %>" rel="stylesheet" type="text/css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="editor-form">
        ...
        <div class="editor-container">
            ...
            <div class="editor-field">
                <%=
                    Html.TextAreaFor (m => m.Body , new { id="body", rows="10", @class = "k-input k-textbox", style = "width:100%; height:45%;" })                                                    
                %>
        ...
        <div class="editor-container">
            <div class="editor-label">
                <%= Html.Label(resBundle.GetString("PBPPlugin", "EmailToolDataModel_Recipients", "Recipients")) %>
            </div>
            <div class="editor-field">
                        ...
                        #
                            ...
                            <div class="lirecipient-right">
                                <a class="k-icon removerecipient-icon" href="\#" 
                                   ...
                                   title="<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteRecipient_Title", "DeleteRecipient_Title") %>"></a>
                            </div>
                        </div>
                    </li>
                </script>
                <div class="list-recipients">
                    <button type="button" id="btn_Addrecipients" class="k-button k-button-icon"
                        ...
                        title="<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Title", "AddRecipients") %>">
                        <span class="k-icon k-add"></span><%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients", "AddRecipients") %>
                    </button>
                    <button type="button" id="btnRemoveAllRecipients" class="k-button k-button-icon"
                        ...
                        title="<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteAllRecipients", "DeleteAllRecipients") %>">
                        <span class="k-icon k-delete"></span><%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteAllRecipients", "DeleteAllRecipients") %>
                    </button>
        ...
        <div class="buttons-container">
            ...
            <div class="buttonsright-container">
                <button type="button" id="btnSendEmails" class="k-button k-button-icon"
                    ...
                    title="<%= resBundle.GetString("PBPPlugin", "EmailTool_Send", "Send") %>">
                    <span class="k-icon sendemail-icon"></span><%= resBundle.GetString("PBPPlugin", "EmailTool_Send", "Send") %>
                </button>
            </div>
    ...
    <div id="dlgAddRecipients">
        ...
        .ToolBar(toolbar =>
        {
            ...
            <div style="float: left;">
                <%= Html.Label(resBundle.GetString("PBPPlugin", "EmailTool_Users", "Users")) %>
            </div>
            <div class="gridFilter">
                <%= Html.Label(resBundle.GetString("PBPPlugin", "EmailTool_Installations", "Installations")) %>
                <% /*if (FormAuthMemberShip.HelperService.InstallationsRoleAllowed("EMAILTOOL_READ").Count >= Model.InstallationsCount)
                   {*/
                       Html.Kendo().DropDownList()
                               .Name("installations")
                               .OptionLabel(resBundle.GetString("PBPPlugin", "EmailTool_InstallationsAll", "InstallationsAll"))
        ...
        <div id="divChks">
            <br />
            <input id="chkAllUsers" type="checkbox" onchange="emailTool_SelectAllUsers(this.checked);" /><label for="chkAllUsers"><%= resBundle.GetString("PBPPlugin", "EmailTool_SelectAllUsers", "SelectAllUsers") %></label>
            </br />
            <input id="chkAllFilteredUsers" type="checkbox" onchange="emailTool_SelectAllFilteredUsers(this.checked);" /><label for="chkAllFilteredUsers"><%= resBundle.GetString("PBPPlugin", "EmailTool_SelectAllFilteredUsers", "SelectAllFilteredUsers") %></label>
        </div>
        ...
        <div class="addrecipients-buttons">
            <button type="button" class="k-button k-button-icon"
                ...
                title="<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Accept", "AddRecipients_Accept") %>">
                <span class="k-icon k-update"></span><%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Accept", "AddRecipients_Accept") %>
            </button>

            <button type="button" class="k-button k-button-icon"
                onclick="$('#dlgAddRecipients').data('kendoWindow').addRecipients = false; $('#dlgAddRecipients').data('kendoWindow').close(); return false;"
                title="<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Cancel", "AddRecipients_Cancel") %>">
                <span class="k-icon k-cancel"></span><%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Cancel", "AddRecipients_Cancel") %>
            </button>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (!dlg.data("kendoWindow")) {
                dlg.kendoWindow({
                    title: "<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Title", "AddRecipients_Title") %>",
                    modal: true,
                    width: "800px",
                    visible: false,
                    actions: [
        ...
        function emailTool_AddRecipientsSave(save) {
                    ...
                    success: function (response) {
                        ...
                        try {
                            ...
                            if (response.Result == true) {
                                ...
                                msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Title", "AddRecipients_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Error", "AddRecipients_Error") %> </br>" + response.ErrorInfo, "warning");
                                kendo.ui.progress($("#lstRecipients"), false);
                            }

                        } catch (ex) {
                            msgboxError("<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Title", "AddRecipients_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_Error", "AddRecipients_Error") %>");
                            kendo.ui.progress($("#lstRecipients"), false);
                        }
            ...
            function emailTool_GetAddRecipientsState() {

                kendo.ui.progress($("#lstRecipients"), true);

                $.ajax({
                    type: 'GET',
                    url: "<%= Url.Action("GetAddRecipientsStatus", "Tools")%>",
                    ...
                    success: function (response) {
                        ...
                        try {
                            ...
                            if (response.RecipientsCount != null) {
                                var msg = "<%= resBundle.GetString("PBPPlugin", "EmailTool_AddRecipients_StatusInfo", "Emails added: {0}") %>";
            ...
            function emailTool_AddRecipientsPaste(pasteText) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<%= Url.Action("AddRecipientsPaste", "Tools")%>",
                ...
                success: function (response) {
                    ...
                    try {
                        ...
                        if (response.Result == true) {
                            ...
                            msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteRecipient_Title", "DeleteRecipient_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteRecipient_Error", "DeleteRecipient_Error") %>: " + response.ErrorInfo, "warning");
                        }

                    } catch (ex) {
                        //msgboxError(instance.options.messages.profile.add.title, instance.options.messages.error.exception);
                        msgboxError("<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteRecipient_Title", "DeleteRecipient_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteRecipient_Error", "DeleteRecipient_Error") %>");
                }
                },
                error: function (xhr) {
            ...
            function emailTool_DeleteAllRecipients() {
                msgboxConfirm("<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteEllRecipients_Title", "DeleteEllRecipients_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteEllRecipients_Confirm", "DeleteEllRecipients_Confirm") %>", "emailTool_DeleteAllRecipients_Confirm()");
        }
        function emailTool_DeleteAllRecipients_Confirm() {
                ...
                success: function (response) {
                    ...
                    try {
                        ...
                        if (response.Result == true) {
                            ...
                            msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteEllRecipients_Title", "DeleteEllRecipients_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteAllRecipients_Error", "DeleteAllRecipients_Error") %>: " + response.ErrorInfo, "warning");
                        }

                    } catch (ex) {
                        //msgboxError(instance.options.messages.profile.add.title, instance.options.messages.error.exception);
                        msgboxError("<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteEllRecipients_Title", "DeleteEllRecipients_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_DeleteAllRecipients_Error", "DeleteAllRecipients_Error") %>");
                    }
            ...
            function emailTool_SendEmails_Confirm() {
                ...
                if (sSubject != "" && sBody != "") {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            try {
                                ...
                                if (response.Result == true) {
                                    setTimeout(function () {
                                        emailTool_GetSendEmailsState();
                                    }, 2000);
                                }
                                else {
                                    msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Title", "SendEmails_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Error", "SendEmails_Error") %>: " + response.ErrorInfo, "warning");
                                kendo.ui.progress($(".editor-form"), false);
                            }

                        } catch (ex) {
                            msgboxError("<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Title", "SendEmails_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Error", "SendEmails_Error") %>");
                            kendo.ui.progress($(".editor-form"), false);
                        }
                    },
                        error: function (xhr) {
                    ...
                    if (sSubject == "")
                        msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Title", "SendEmails_Title") %>", "<%= String.Format(resBundle.GetString("PBPPlugin", "ErrorsMsg_RequiredField", "RequiredField"), resBundle.GetString("PBPPlugin", "EmailToolDataModel_Subject", "Subject")) %>", "warning");
                    else
                        msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Title", "SendEmails_Title") %>", "<%= String.Format(resBundle.GetString("PBPPlugin", "ErrorsMsg_RequiredField", "RequiredField"), resBundle.GetString("PBPPlugin", "EmailToolDataModel_Body", "Body")) %>", "warning");
                }

            }

            function emailTool_GetSendEmailsState() {

                kendo.ui.progress($(".editor-form"), true);

                $.ajax({
                    type: 'GET',
                    url: "<%= Url.Action("GetSendEmailsStatus", "Tools")%>",
                data: { plugin: 'PBPPlugin', uniqueId: '<%: Model.UniqueId %>' },
                success: function (response) {
                    ...
                    try {
                        ...
                        if (response.Result == true) {
                            ...
                            if (response.SendEmailsResult) {
                                msgboxAlert("<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Title", "SendEmails_Title") %>", "<%= resBundle.GetString("PBPPlugin", "EmailTool_SendEmails_Success", "SendEmails_Success") %>", "information");
