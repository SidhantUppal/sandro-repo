...
<h2></h2>
    ...
    <script src="<%= Url.Content(RouteConfig.BasePath + "ReportViewer/js/telerikReportViewer-9.2.15.1126." + System.Threading.Thread.CurrentThread.CurrentCulture + ".js?v1.0") %>" ></script>
