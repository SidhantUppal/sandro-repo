                    ...
                    <div class="pane-content" style="height: 100%;">
                        ...
                        <%= Html.Kendo().Chart<ChartDataItem>()
                                ...
                                .Series(series =>
                                {
                                    ...
                                    series.Column(model => model.Serie0).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUser"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ParkingOperation.ToString()))).Stack("users");
                                    series.Column(model => model.Serie1).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUser"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ExtensionOperation.ToString()))).Stack("users");
                                    series.Column(model => model.Serie2).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUser"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ParkingRefund.ToString()))).Stack("users");
                                    series.Column(model => model.Serie3).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUser"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.TicketPayment.ToString()))).Stack("users");
                                })
                ...
                .Content(() => { %>
                    <div class="pane-content" style="height: 100%;">
                        ...
                        <%= Html.Kendo().Chart<ChartDataItem>()
                                ...
                                {
                                    //series.Column(model => model.Total).Name("Operations");
                                    series.Column(model => model.Serie0).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUserAll"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ParkingOperation.ToString()))).Stack("allusers");
                                    series.Column(model => model.Serie1).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUserAll"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ExtensionOperation.ToString()))).Stack("allusers");
                                    series.Column(model => model.Serie2).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUserAll"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.ParkingRefund.ToString()))).Stack("allusers");
                                    series.Column(model => model.Serie3).Name(string.Format(resBundle.GetString("PBPPlugin", "Dashboard_SerieOperationsUserAll"), resBundle.GetString("PBPPlugin", "ChargeOperationsTypes_" + ChargeOperationsType.TicketPayment.ToString()))).Stack("allusers");
                                })
                                .CategoryAxis(axis => axis
                                    .Categories(model => model.Category)                            
                                    .Labels(labels => labels
