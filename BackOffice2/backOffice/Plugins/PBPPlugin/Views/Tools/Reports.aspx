...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <link href="<%= Url.Content(RouteConfig.BasePath + "ReportViewer/styles/telerikReportViewer.css?v2") %>" rel="stylesheet" type="text/css" />
...
<h2></h2>
    ...
    <%: Html.TelerikReporting().ReportViewer()
        ...
        .TemplateUrl(Url.Content(RouteConfig.BasePath + "ReportViewer/templates/telerikReportViewerTemplate." + culture + ".html"))
    ...
    <script src="<%= Url.Content(RouteConfig.BasePath + "ReportViewer/js/telerikReportViewer-10.1.16.615." + System.Threading.Thread.CurrentThread.CurrentCulture + ".js") %>"></script>
