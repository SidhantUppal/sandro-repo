...
namespace PBPPlugin.ResourceExt
{
        ...
        public static string GetLiteral(string strLiteral)
        {
            ...
            try
            {
                ...
                lock (m_oLiteralsCache)
                {
                    ...
                    string strFile = strLiteral + ".html";
                    ...
                    try
                    {
                        ...
                        {
                            strContentFolderRoot = HttpContext.Current.Server.MapPath(RouteConfig.BasePath + "ResourceExt"); 
                            // System.IO.Path.Combine(HttpContext.Current.Request.PhysicalApplicationPath, "ResourceExt");
                        }
                        else
                        {
