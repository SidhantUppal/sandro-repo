...
namespace integraMobile.Domain.NH.Entities
{
  ...
  public partial class Country
  {
    ...
    private IList<Installation> _installations = new List<Installation>();

    public virtual IList<Installation> Installations
    {
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='Country'
    ...
    <bag name='Installations'
          inverse='true'
          >
      <key column='`INS_COU_ID`' />
  ...
  public partial class UsersSecurityOperation
  {
    ...
    public virtual int UsopSendByPush { get; set; }
    public virtual System.Nullable<decimal> UsopUpidId { get; set; }
    public virtual System.Nullable<decimal> UsopUnoId { get; set; }

    public virtual Country UsopNewMainTelCountry { get; set; }

    public virtual User UsopUsr { get; set; }

    public virtual UsersNotification UsopUno { get; set; }

    public virtual UsersPushId UsopUpid { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='UsersSecurityOperation'
    ...
    <property name='UsopActivationCode'
              ...
              />
    <property name='UsopSendByPush'
              column='`USOP_SEND_BY_PUSH`'
              />
    <property name='UsopUpidId'
              column='`USOP_UPID_ID`'
              />
    <property name='UsopUnoId'
              column='`USOP_UNO_ID`'
              />
    ...
    <many-to-one name='UsopUno' class='UsersNotification' column='`USOP_UNO_ID`' />
    <many-to-one name='UsopUpid' class='UsersPushId' column='`USOP_UPID_ID`' />
  </class>
</hibernate-mapping>");
        CustomizeMappingDocument(mappingDocument);
        return mappingDocument;
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class CustomerPaymentMean
  {
    ...
    public virtual System.Nullable<decimal> CuspmCptgcId { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='CustomerPaymentMean'
    ...
    <property name='CuspmCreditCardPaymentProvider'
              ...
              />
    <property name='CuspmCptgcId'
              column='`CUSPM_CPTGC_ID`'
              />
    <bag name='CustomerPaymentMeansRecharges'
          inverse='false'
          >
  ...
  public partial class CustomerPaymentMeansRecharge
  {
    ...
    [Length(Max=50)]
    public virtual string CuspmrPaypalIntent { get; set; }
    public virtual System.Nullable<int> CuspmrPaypalTransactionFeeValue { get; set; }
    [Length(Max=10)]
    public virtual string CuspmrPaypalTransactionFeeCurrencyIsocode { get; set; }
    [Length(Max=250)]
    public virtual string CuspmrPaypalTransactionUrl { get; set; }
    [Length(Max=250)]
    public virtual string CuspmrPaypalTransactionRefundUrl { get; set; }
    public virtual System.Nullable<decimal> CuspmrInsId { get; set; }
    public virtual System.Nullable<decimal> CuspmrFdoId { get; set; }
    [Length(Max=256)]
    public virtual string CuspmrBackofficeUsr { get; set; }
    public virtual System.Nullable<decimal> CuspmrCptgcId { get; set; }
    [Length(Max=15)]
    public virtual string CuspmrOxxoToken { get; set; }
    public virtual System.Nullable<int> CuspmrOxxoCashMachine { get; set; }
    [Length(Max=3)]
    public virtual string CuspmrOxxoEntryMode { get; set; }
    public virtual System.Nullable<decimal> CuspmrOxxoTicket { get; set; }
    public virtual System.Nullable<decimal> CuspmrOxxoFolio { get; set; }
    public virtual System.Nullable<System.DateTime> CuspmrOxxoAdminDate { get; set; }
    [Length(Max=10)]
    public virtual string CuspmrOxxoStore { get; set; }
    [Length(Max=1)]
    public virtual string CuspmrOxxoPartial { get; set; }
    public virtual System.Nullable<decimal> CuspmrSrcCurId { get; set; }
    public virtual System.Nullable<int> CuspmrSrcAmount { get; set; }
    public virtual System.Nullable<decimal> CuspmrSrcChangeApplied { get; set; }
    public virtual System.Nullable<decimal> CuspmrSrcChangeFeeApplied { get; set; }
    ...
    public virtual Currency CuspmrSrcCur { get; set; }
    ...
    public virtual Installation CuspmrIns { get; set; }

    public virtual FinanDistOperator CuspmrFdo { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='CustomerPaymentMeansRecharge'
    ...
    <property name='CuspmrCreationType'
              ...
              />
    <property name='CuspmrPaypalIntent'
              column='`CUSPMR_PAYPAL_INTENT`'
              />
    <property name='CuspmrPaypalTransactionFeeValue'
              column='`CUSPMR_PAYPAL_TRANSACTION_FEE_VALUE`'
              />
    <property name='CuspmrPaypalTransactionFeeCurrencyIsocode'
              column='`CUSPMR_PAYPAL_TRANSACTION_FEE_CURRENCY_ISOCODE`'
              />
    <property name='CuspmrPaypalTransactionUrl'
              column='`CUSPMR_PAYPAL_TRANSACTION_URL`'
              />
    <property name='CuspmrPaypalTransactionRefundUrl'
              column='`CUSPMR_PAYPAL_TRANSACTION_REFUND_URL`'
              />
    <property name='CuspmrInsId'
              column='`CUSPMR_INS_ID`'
              />
    <property name='CuspmrFdoId'
              column='`CUSPMR_FDO_ID`'
              />
    <property name='CuspmrBackofficeUsr'
              column='`CUSPMR_BACKOFFICE_USR`'
              />
    <property name='CuspmrCptgcId'
              column='`CUSPMR_CPTGC_ID`'
              />
    <property name='CuspmrOxxoToken'
              column='`CUSPMR_OXXO_TOKEN`'
              />
    <property name='CuspmrOxxoCashMachine'
              column='`CUSPMR_OXXO_CASH_MACHINE`'
              />
    <property name='CuspmrOxxoEntryMode'
              column='`CUSPMR_OXXO_ENTRY_MODE`'
              />
    <property name='CuspmrOxxoTicket'
              column='`CUSPMR_OXXO_TICKET`'
              />
    <property name='CuspmrOxxoFolio'
              column='`CUSPMR_OXXO_FOLIO`'
              />
    <property name='CuspmrOxxoAdminDate'
              column='`CUSPMR_OXXO_ADMIN_DATE`'
              />
    <property name='CuspmrOxxoStore'
              column='`CUSPMR_OXXO_STORE`'
              />
    <property name='CuspmrOxxoPartial'
              column='`CUSPMR_OXXO_PARTIAL`'
              />
    <property name='CuspmrSrcCurId'
              column='`CUSPMR_SRC_CUR_ID`'
              />
    <property name='CuspmrSrcAmount'
              column='`CUSPMR_SRC_AMOUNT`'
              />
    <property name='CuspmrSrcChangeApplied'
              column='`CUSPMR_SRC_CHANGE_APPLIED`'
              />
    <property name='CuspmrSrcChangeFeeApplied'
              column='`CUSPMR_SRC_CHANGE_FEE_APPLIED`'
              />
    <bag name='Operations'
          inverse='false'
          >
    ...
    <many-to-one name='CuspmrSrcCur' class='Currency' column='`CUSPMR_SRC_CUR_ID`' />
    ...
    <many-to-one name='CuspmrIns' class='Installation' column='`CUSPMR_INS_ID`' />
    <many-to-one name='CuspmrFdo' class='FinanDistOperator' column='`CuspmrFdoId`' />
  </class>
</hibernate-mapping>");
        CustomizeMappingDocument(mappingDocument);
        return mappingDocument;
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class Operation
  {
    ...
    [Length(Max=50)]
    public virtual string OpeSpaceString { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='Operation'
    ...
    <property name='OpeBonusType'
              ...
              />
    <property name='OpeSpaceString'
              column='`OPE_SPACE_STRING`'
              />
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class OperationsOffstreet
  {
    ...
    public virtual System.Nullable<decimal> OpeoffPercVat1 { get; set; }
    public virtual System.Nullable<decimal> OpeoffPercVat2 { get; set; }
    public virtual System.Nullable<decimal> OpeoffPartialVat1 { get; set; }
    public virtual System.Nullable<decimal> OpeoffPercFee { get; set; }
    public virtual System.Nullable<decimal> OpeoffPercFeeTopped { get; set; }
    public virtual System.Nullable<decimal> OpeoffPartialPercFee { get; set; }
    public virtual System.Nullable<decimal> OpeoffFixedFee { get; set; }
    public virtual System.Nullable<decimal> OpeoffPartialFixedFee { get; set; }
    public virtual System.Nullable<int> OpeoffTotalAmount { get; set; }
    [Length(Max=500)]
    public virtual string OpeoffDiscountCodes { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='OperationsOffstreet'
    ...
    <property name='OpeoffCusinvId'
              ...
              />
    <property name='OpeoffPercVat1'
              column='`OPEOFF_PERC_VAT1`'
              />
    <property name='OpeoffPercVat2'
              column='`OPEOFF_PERC_VAT2`'
              />
    <property name='OpeoffPartialVat1'
              column='`OPEOFF_PARTIAL_VAT1`'
              />
    <property name='OpeoffPercFee'
              column='`OPEOFF_PERC_FEE`'
              />
    <property name='OpeoffPercFeeTopped'
              column='`OPEOFF_PERC_FEE_TOPPED`'
              />
    <property name='OpeoffPartialPercFee'
              column='`OPEOFF_PARTIAL_PERC_FEE`'
              />
    <property name='OpeoffFixedFee'
              column='`OPEOFF_FIXED_FEE`'
              />
    <property name='OpeoffPartialFixedFee'
              column='`OPEOFF_PARTIAL_FIXED_FEE`'
              />
    <property name='OpeoffTotalAmount'
              column='`OPEOFF_TOTAL_AMOUNT`'
              />
    <property name='OpeoffDiscountCodes'
              column='`OPEOFF_DISCOUNT_CODES`'
              />
  ...
  public partial class OperationsOffstreetSessionInfo
  {
    ...
    public virtual System.Nullable<decimal> OosiPercVat1 { get; set; }
    public virtual System.Nullable<decimal> OosiPercVat2 { get; set; }
    public virtual System.Nullable<decimal> OosiPartialVat1 { get; set; }
    public virtual System.Nullable<decimal> OosiPercFee { get; set; }
    public virtual System.Nullable<decimal> OosiPercFeeTopped { get; set; }
    public virtual System.Nullable<decimal> OosiFixedFee { get; set; }
    [Length(Max=500)]
    public virtual string OosiDiscountCodes { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='OperationsOffstreetSessionInfo'
    ...
    <property name='OosiTariff'
              column='`OOSI_TARIFF`'
              />
    <property name='OosiPercVat1'
              column='`OOSI_PERC_VAT1`'
              />
    <property name='OosiPercVat2'
              column='`OOSI_PERC_VAT2`'
              />
    <property name='OosiPartialVat1'
              column='`OOSI_PARTIAL_VAT1`'
              />
    <property name='OosiPercFee'
              column='`OOSI_PERC_FEE`'
              />
    <property name='OosiPercFeeTopped'
              column='`OOSI_PERC_FEE_TOPPED`'
              />
    <property name='OosiFixedFee'
              column='`OOSI_FIXED_FEE`'
              />
    <property name='OosiDiscountCodes'
              column='`OOSI_DISCOUNT_CODES`'
              />
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class RetailerPayment
  {
    ...
    public virtual System.Nullable<decimal> RtlpyCptgcId { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='RetailerPayment'
    ...
    <property name='RtlpyCreditCardPaymentProvider'
              ...
              />
    <property name='RtlpyCptgcId'
              column='`RTLPY_CPTGC_ID`'
              />
    <bag name='RechargeCoupons'
          inverse='false'
          >
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class User
  {
    ...
    public virtual System.Nullable<System.DateTime> UsrLastBalanceUse { get; set; }
    public virtual System.Nullable<int> UsrSignupOs { get; set; }
    public virtual System.Nullable<decimal> UsrInaaId { get; set; }
    public virtual System.Nullable<decimal> UsrFirstOperationInsId { get; set; }
    public virtual System.Nullable<decimal> UsrLastOperationInsId { get; set; }
    [Length(Max=50)]
    public virtual string UsrSignupGuid { get; set; }
    ...
    public virtual Installation UsrFirstOperationIns { get; set; }

    public virtual Installation UsrLastOperationIns { get; set; }

    public virtual LicenseTerm UsrLct { get; set; }

    public virtual InstallationAutomaticAssignation UsrInaa { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='User'
    ...
    <property name='UsrPaymeth'
              column='`USR_PAYMETH`'
              />
    <property name='UsrLastBalanceUse'
              column='`USR_LAST_BALANCE_USE`'
              />
    <property name='UsrSignupOs'
              column='`USR_SIGNUP_OS`'
              />
    <property name='UsrInaaId'
              column='`USR_INAA_ID`'
              />
    <property name='UsrFirstOperationInsId'
              column='`USR_FIRST_OPERATION_INS_ID`'
              />
    <property name='UsrLastOperationInsId'
              column='`USR_LAST_OPERATION_INS_ID`'
              />
    <property name='UsrSignupGuid'
              column='`USR_SIGNUP_GUID`'
              />
    <bag name='CustomerPaymentMeansRecharges'
          inverse='false'
          >
    ...
    <many-to-one name='UsrFirstOperationIns' class='Installation' column='`USR_FIRST_OPERATION_INS_ID`' />
    <many-to-one name='UsrLastOperationIns' class='Installation' column='`USR_LAST_OPERATION_INS_ID`' />
    <many-to-one name='UsrLct' class='LicenseTerm' column='`USR_LCT_ID`' />
    <many-to-one name='UsrInaa' class='InstallationAutomaticAssignation' column='`USR_INAA_ID`' />
  </class>
</hibernate-mapping>");
        CustomizeMappingDocument(mappingDocument);
        return mappingDocument;
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class UsersNotification
  {
    ...
    public virtual System.Nullable<decimal> UnoUpidId { get; set; }
    ...
    public virtual UsersPushId UnoUpid { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='UsersNotification'
    ...
    <bag name='UsersSecurityOperations'
          inverse='false'
          >
      <key column='`USOP_UNO_ID`' />
      <one-to-many class='UsersSecurityOperation' />
    </bag>
    <many-to-one name='UnoUsr' class='User' column='`UNO_USR_ID`' />
    <many-to-one name='UnoUpid' class='UsersPushId' column='`UNO_UPID_ID`' />
  </class>
</hibernate-mapping>");
        CustomizeMappingDocument(mappingDocument);
        return mappingDocument;
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='UsersPushId'
    ...
    <bag name='UsersSecurityOperations'
          inverse='false'
          >
      <key column='`USOP_UPID_ID`' />
      <one-to-many class='UsersSecurityOperation' />
    </bag>
    <bag name='UsersNotifications'
          inverse='false'
          >
      <key column='`UNO_UPID_ID`' />
      <one-to-many class='UsersNotification' />
    </bag>
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  public partial class Installation
  {
    ...
    public virtual int InsOptParkbycurrentlocen { get; set; }
    public virtual int InsOptParkbycurrentlocaccuracy { get; set; }
    public virtual int InsOptParkbycurrentlocant { get; set; }
    public virtual int InsOptParkbyfavlocen { get; set; }
    public virtual System.Nullable<int> InsOptRechargePaypal { get; set; }
    public virtual System.Nullable<int> InsOptRechargeOxxo { get; set; }
    public virtual System.Nullable<int> InsTollQrExpirationSec { get; set; }
    public virtual System.Nullable<int> InsTollBlockingAmount { get; set; }
    public virtual System.Nullable<int> InsTollBlockingMaxMin { get; set; }
    public virtual decimal InsCouId { get; set; }
    ...
    private IList<InstallationAutomaticAssignation> _installationAutomaticAssignations = new List<InstallationAutomaticAssignation>();

    public virtual IList<InstallationAutomaticAssignation> InstallationAutomaticAssignations
    {
      get { return _installationAutomaticAssignations; }
      set { _installationAutomaticAssignations = value; }
    }
    ...
    private IList<User> _usersByUsrFirstOperationIns = new List<User>();

    public virtual IList<User> UsersByUsrFirstOperationIns
    {
      get { return _usersByUsrFirstOperationIns; }
      set { _usersByUsrFirstOperationIns = value; }
    }

    private IList<User> _usersByUsrLastOperationIns = new List<User>();

    public virtual IList<User> UsersByUsrLastOperationIns
    {
      get { return _usersByUsrLastOperationIns; }
      set { _usersByUsrLastOperationIns = value; }
    }

    public virtual Country InsCou { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='Installation'
    ...
    <property name='InsOptConfigmenu'
              ...
              />
    <property name='InsOptParkbycurrentlocen'
              column='`INS_OPT_PARKBYCURRENTLOCEN`'
              />
    <property name='InsOptParkbycurrentlocaccuracy'
              column='`INS_OPT_PARKBYCURRENTLOCACCURACY`'
              />
    <property name='InsOptParkbycurrentlocant'
              column='`INS_OPT_PARKBYCURRENTLOCANT`'
              />
    <property name='InsOptParkbyfavlocen'
              column='`INS_OPT_PARKBYFAVLOCEN`'
              />
    <property name='InsOptRechargePaypal'
              column='`INS_OPT_RECHARGE_PAYPAL`'
              />
    <property name='InsOptRechargeOxxo'
              column='`INS_OPT_RECHARGE_OXXO`'
              />
    <property name='InsTollQrExpirationSec'
              column='`INS_TOLL_QR_EXPIRATION_SEC`'
              />
    <property name='InsTollBlockingAmount'
              column='`INS_TOLL_BLOCKING_AMOUNT`'
              />
    <property name='InsTollBlockingMaxMin'
              column='`INS_TOLL_BLOCKING_MAX_MIN`'
              />
    <property name='InsCouId'
              column='`INS_COU_ID`'
              />
    <bag name='ExternalParkingOperations'
          inverse='true'
    ...
    <bag name='InstallationAutomaticAssignations'
          inverse='false'
          >
      <key column='`INAA_INS_ID`' />
      <one-to-many class='InstallationAutomaticAssignation' />
    </bag>
    <bag name='CustomerPaymentMeansRecharges'
          inverse='false'
          >
      <key column='`CUSPMR_INS_ID`' />
      <one-to-many class='CustomerPaymentMeansRecharge' />
    </bag>
    <bag name='UsersByUsrFirstOperationIns'
          inverse='false'
          >
      <key column='`USR_FIRST_OPERATION_INS_ID`' />
      <one-to-many class='User' />
    </bag>
    <bag name='UsersByUsrLastOperationIns'
          inverse='false'
          >
      <key column='`USR_LAST_OPERATION_INS_ID`' />
      <one-to-many class='User' />
    </bag>
    <many-to-one name='InsCou' class='Country' column='`INS_COU_ID`' />
  ...
  public partial class VwUser
  {
    ...
    public virtual System.Nullable<int> DaysWithoutOps { get; set; }
    public virtual System.Nullable<int> UsrSignupOs { get; set; }
    public virtual System.Nullable<decimal> UsrInaaId { get; set; }
    public virtual System.Nullable<decimal> UsrFirstOperationInsId { get; set; }
    public virtual System.Nullable<decimal> UsrLastOperationInsId { get; set; }
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  <class name='VwUser'
    ...
    <property name='PaymentMethod'
              ...
              />
    <property name='DaysWithoutOps'
              column='`DaysWithoutOps`'
              />
    <property name='UsrSignupOs'
              column='`USR_SIGNUP_OS`'
              />
...
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
  ...
  [System.CodeDom.Compiler.GeneratedCode("NHibernateModelGenerator", "1.0.0.0")]
  public partial class InstallationAutomaticAssignation
  {
    public virtual decimal InaaId { get; set; }
    [NotNull]
    [Length(Max=200)]
    public virtual string InaaDescription { get; set; }
    public virtual decimal InaaCouId { get; set; }
    [NotNull]
    [Length(Max=20)]
    public virtual string InaaPrefix { get; set; }
    public virtual int InaaPositionsAfterPrefix { get; set; }
    public virtual System.Nullable<decimal> InaaInsId { get; set; }
    ...
    public virtual Installation InaaIns { get; set; }
    ...
    internal static System.Xml.Linq.XDocument MappingXml
    {
      get
      {
        var mappingDocument = System.Xml.Linq.XDocument.Parse(@"<?xml version='1.0' encoding='utf-8' ?>
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
                   assembly='" + typeof(InstallationAutomaticAssignation).Assembly.GetName().Name + @"'
                   namespace='integraMobile.Domain.NH.Entities'
                   >
  <class name='InstallationAutomaticAssignation'
         table='`INSTALLATION_AUTOMATIC_ASSIGNATION`'
         >
    <id name='InaaId'
        column='`INAA_ID`'
        >
    ...
    <property name='InaaDescription'
              column='`INAA_DESCRIPTION`'
              />
    <property name='InaaCouId'
              column='`INAA_COU_ID`'
              />
    <property name='InaaPrefix'
              column='`INAA_PREFIX`'
              />
    <property name='InaaPositionsAfterPrefix'
              column='`INAA_POSITIONS_AFTER_PREFIX`'
              />
    <property name='InaaInsId'
              column='`INAA_INS_ID`'
              />
    <bag name='Users'
          inverse='false'
          >
      <key column='`USR_INAA_ID`' />
      <one-to-many class='User' />
    </bag>
    <many-to-one name='InaaIns' class='Installation' column='`INAA_INS_ID`' />
  </class>
</hibernate-mapping>");
        CustomizeMappingDocument(mappingDocument);
        return mappingDocument;
  ...
  [System.CodeDom.Compiler.GeneratedCode("NHibernateModelGenerator", "1.0.0.0")]
  public partial class FinanDistOperator
  {
    public virtual decimal FdoId { get; set; }
    [NotNull]
    [Length(Max=50)]
    public virtual string FdoDesccription { get; set; }
    public virtual int FdoMain { get; set; }
    public virtual int FdoIscouncil { get; set; }
    ...
    internal static System.Xml.Linq.XDocument MappingXml
    {
      get
      {
        var mappingDocument = System.Xml.Linq.XDocument.Parse(@"<?xml version='1.0' encoding='utf-8' ?>
<hibernate-mapping xmlns='urn:nhibernate-mapping-2.2'
                   assembly='" + typeof(FinanDistOperator).Assembly.GetName().Name + @"'
                   namespace='integraMobile.Domain.NH.Entities'
                   >
  <class name='FinanDistOperator'
         table='`FINAN_DIST_OPERATORS`'
         >
    <id name='FdoId'
        column='`FDO_ID`'
        >
    ...
    <property name='FdoDesccription'
              column='`FDO_DESCCRIPTION`'
              />
    <property name='FdoMain'
              column='`FDO_MAIN`'
              />
    <property name='FdoIscouncil'
              column='`FDO_ISCOUNCIL`'
              />
    <bag name='CustomerPaymentMeansRecharges'
          inverse='false'
          >
      <key column='`CuspmrFdoId`' />
      <one-to-many class='CustomerPaymentMeansRecharge' />
    </bag>
  </class>
</hibernate-mapping>");
  ...
  public static class ConfigurationHelper
  {
    ...
    public static void ApplyConfiguration(Configuration configuration)
    {
      ...
      configuration.AddXml(InstallationAutomaticAssignation.MappingXml.ToString());
      configuration.AddXml(FinanDistOperator.MappingXml.ToString());
