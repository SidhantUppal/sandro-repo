namespace integraMobile.Reports.Finantial
{
    ...
    /// </summary>
    public partial class Bank : Telerik.Reporting.Report
    {
        public Bank()
        {
            //
            ...
            txtAccount.Value = (System.Configuration.ConfigurationManager.AppSettings["FinantialReport_Bank_Account"] ?? "BSAN002925");

        }

        private void Bank_ItemDataBinding(object sender, EventArgs e)
        {
