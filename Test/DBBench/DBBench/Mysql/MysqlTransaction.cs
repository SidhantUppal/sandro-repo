...
namespace DBBench.Mysql
{
    public class MysqlTransaction : IMysqlTransaction
    {
        ...
        public MysqlTransaction(bool bStateless)
        {
        ...
        public MysqlTransaction(NHSessionManager.ConnectionConfiguration oConnectionConfig, bool bStateless)
        {
            _stateless = bStateless;
        ...
        public MysqlTransaction(ISession oSession)
        {
            _stateless = false;
            Session = oSession;
        }
        public MysqlTransaction(ISession oSession, ITransaction oTransaction)
        {
            _stateless = false;
            Session = oSession;
            Transaction = oTransaction;
        }
        public MysqlTransaction(IStatelessSession oStatelessSession)
        {
            _stateless = true;
            StatelessSession = oStatelessSession;
        }
        public MysqlTransaction(IStatelessSession oStatelessSession, ITransaction oTransaction)
        {
            _stateless = true;
            StatelessSession = oStatelessSession;
            Transaction = oTransaction;
