...
{
    public class MysqlConnectionHelper : IDisposable
    {
        #region Protected Attrib

        private static readonly CLogWrapper m_Log = new CLogWrapper(typeof(MysqlConnectionHelper));
        ...
        public MysqlConnectionHelper(ISession oSession, IMysqlTransaction trans = null)
        {
            _stateless = false;

            if (trans != null && trans.GetType() == typeof(MysqlTransaction))
            {
                var oiParkTicketTransaction = (MysqlTransaction)trans;
        ...
        public MysqlConnectionHelper(IStatelessSession oStatelessSession, IMysqlTransaction trans = null)
        {
            _stateless = true;
        ...
        public MysqlConnectionHelper(NHSessionManager.ConnectionConfiguration oConnectionConfig, ISession oSession, IMysqlTransaction trans = null)
        {
            _stateless = false;
        ...
        public MysqlConnectionHelper(NHSessionManager.ConnectionConfiguration oConnectionConfig, IStatelessSession oStatelessSession, IMysqlTransaction trans = null)
        {
            _stateless = true;
            _connectionConfig = oConnectionConfig;
        ...
        public IMysqlTransaction GetiParkTicketTransaction()
        {
            return !_stateless
                ? new MysqlTransaction(Session, Transaction)
                : new MysqlTransaction(StatelessSession, Transaction);
        }
