...
using integraMobile.Infrastructure.Logging;
using System.Collections;
using System.Xml;
using System.Collections.Specialized;

namespace integraMobile.WS.Test.Helpers
{
    public class Tools
    {
        #region Constants
        ...
        #region Properties
        //private static readonly Tools.CLogWrapper m_Log = new Tools.CLogWrapper(typeof(CreditCallController));
