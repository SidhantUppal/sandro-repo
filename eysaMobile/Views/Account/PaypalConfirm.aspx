...
<% using (Html.BeginForm("PaypalSuccess", "Account", FormMethod.Post))
   { %>
<div class="cajagris">
...
<input type="button" value="<%=Resources.Account_RechargeButton_Cancel%>" class="botongris" onclick="location.href='PaypalCancel';"/>
<% } %>
</br>
</div>
