...
<h2></h2>
<h3><%=Resources.Account_Register_PaymentMeanCancelled%></h3>
<div class="cajagris">
...
%>
	...
	<div class="greentext"><%=string.Format(Resources.Account_Register_PaymentMeanMessageCancel, string.Format(provider, "{0:0.00}", 
