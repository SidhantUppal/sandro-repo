...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	SecurityOperationForgotPassword
</asp:Content>
...
<h2><%=Resources.SecurityOperationForgotPassword_IdentityValidation%></h2>
<br />
...
<% using (Html.BeginForm("SecurityOperationForgotPassword", "Account", FormMethod.Post))
   { %>  
<p><%=String.Format(Resources.SecurityOperationForgotPassword_Step2WriteYourCode1,
...
<div class="div100" style="text-align:right">
 ...
 <%=Resources.SecurityOperationForgotPassword_Step2WriteYourCode2%>
