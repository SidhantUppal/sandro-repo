...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	SecurityOperationForgotPasswordConfirmation
</asp:Content>
...
<h2><%=Resources.SecurityOperationForgotPassword_Confirmation%></h2>
...
<div class="div100" style="text-align:left">
 <p>
 <%=Resources.SecurityOperationForgotPassword_ConfirmationText1 %><br />
 <p>
<p class="aclaracion">                                                                                
<%=ViewData["Password"] %>
 </p>  
